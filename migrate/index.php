...
<html>
    <head>
		<title>Ottocrat CRM Setup</title>
    ...
    <body>
		<div class="container-fluid page-container">
			<div class="row-fluid">
				<div class="span6">
					<div class="logo">
						<img src="resources/images/vt1.png" alt="Ottocrat Logo"/>
					</div>
				</div>
				<div class="span6">
				...
				<div class="span12 inner-container">
					...
					<div class="row-fluid">
						<div class="span4 welcome-image">
							<img src="resources/images/migration_screen.png" alt="Ottocrat Logo"/>
						</div>
						<div class="span8">
							<?php $currentVersion = explode('.', $ottocrat_current_version);
							if($currentVersion[0] >= 6 && $currentVersion[1] >= 0){?>
							<div>
								<h3> Welcome to Ottocrat Migration </h3>
								<?php
								if(isset($_REQUEST['error'])) {
									echo '<span><font color="red"><b>'.filter_var($_REQUEST['error'], FILTER_SANITIZE_STRING).'</b></font></span><br><br>';
								}?>
								<p>We have detected that you have <strong>Ottocrat <?php echo $ottocrat_current_version?> </strong>installation. <br> <br> </p>
								<p>
									<strong> Warning: </strong>Please note that it is not possible to revert back to <?php echo $ottocrat_current_version?> after the upgrade to ottocrat 6 <br>
									So, it is important to take a backup of the <?php echo $ottocrat_current_version?> installation, including the source files
									and database.</p><br>
								<form action="index.php" method="POST">
									<div><input type="checkbox" id="checkBox1" name="checkBox1"/> <div class="chkbox"></div> I have taken the backup of database <a href="http://community.ottocrat.com/help/ottocratcrm/administrators/backup.html" target="_blank" >(how to?)</a> </div><br>
									<div><input type="checkbox" id="checkBox2" name="checkBox2"/> <div class="chkbox"></div> I have taken the backup of source folder <a href="http://community.ottocrat.com/help/ottocratcrm/administrators/backup.html" target="_blank" >(how to?)</a></div><br>
									<br><div>
										<span id="error"></span>
							...
							<div><br><br><br><br><br>
								...
								<p>
									We detected that this installation is running <strong>Ottocrat CRM </strong><?php if($ottocrat_current_version < 6 ) { echo '<b>'.$ottocrat_current_version.'</b>'; } ?>.
