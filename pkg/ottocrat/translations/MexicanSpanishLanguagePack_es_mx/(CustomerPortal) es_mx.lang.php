...
'LBL_STATUS_CLOSED'=>'Cerrado',//Do not convert this label. This is used to check the status. If the status 'Closed' is changed in ottocratCRM server side then you will give the exact value of status 'Closed' which is in ottocratCRM server.
