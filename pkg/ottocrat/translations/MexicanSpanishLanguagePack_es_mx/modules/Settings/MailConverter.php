...
$languageStrings = array(
    ...
    'LBL_MAILCONVERTER_DESCRIPTION'   =>   "Analizador de correo permite configurar un buzón de correo para escanear tus correos electrónicos y crear entidades apropiadas en Ottocrat CRM. <br> Además tendrás que definir las reglas para especificar qué acciones deben realizarse en el correo electrónico. <br> Tus correos electrónicos son analizados de forma automática, a menos que hayas desactivado tarea de analizador de correo en el Programador de eventos. <br> <br> <br>",
