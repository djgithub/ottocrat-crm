 ...
 * Dutch language pack for ottocrat CRM version 6.x
 * 
 * @package   NL-Dutch
 * @author    $Author: luuk $
 * @version   CVS: $Revision: 1.5 $ $Date: 2014/09/07 21:06:45 $
 * @source    $Source: /var/lib/cvs/ottocrat600/languages/nl_nl/Settings/Ottocrat.php,v $
...
$languageStrings = array(
    ...
    'LBL_DEFAULT'                  => 'By default, SMTP account settings for the outgoing server are configured to od1.ottocrat.com mail server. To avoid outgoing emails getting filtered out by spam filters on your recipient ISP mail server, we recommend you implement one of the following.', // TODO: Review
    ...
    'LBL_OPTIONS2'                 => 'Add od1.ottocrat.com server as a authorized sender for your domain.<br>- If you prefer to retain the ottocrat server as the outgoing server, we recommend that you configure your domain\'s SPF record to include the ottocrat server as a valid sender for your domain. For additonal instruction on setting up SPF record, please email od-support@ottocrat.com .', // TODO: Review
    ...
    'LBL_CONFIG_DESCRIPTION'       => 'Edit the Configuration details of ottocrat CRM', // TODO: Review
