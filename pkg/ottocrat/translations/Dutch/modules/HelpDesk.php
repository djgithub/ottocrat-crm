 ...
 * @source    $Source: /var/lib/cvs/ottocrat600/languages/nl_nl/HelpDesk.php,v $
...
$languageStrings = array(
    ...
    'LBL_STATUS_CLOSED' => 'Closed', //Do not convert this label. This is used to check the status. If the status 'Closed' is changed in ottocratCRM server side then you have to change in customerportal language file also.
