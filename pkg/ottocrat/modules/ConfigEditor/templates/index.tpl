...
<table border=0 cellspacing=0 cellpadding=0 width=98% align=center>
	...
	<tr>
		<td valign=top align=right width=8><img src="{'showPanelTopLeft.gif'|@ottocrat_imageurl:$THEME}"></td>
		<td class="showPanelBg" valign="top" width="100%" >

			<div style="padding: 20px;">
				<form onsubmit="OttocratJS_DialogBox.block();" action="index.php" method="POST" name="EditView">
					<div align="center">
		...
		<td valign=top align=right><img src="{'showPanelTopRight.gif'|@ottocrat_imageurl:$THEME}"></td>
	</tr>
</table>
</body>
