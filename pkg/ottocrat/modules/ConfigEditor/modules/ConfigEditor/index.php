...
class ConfigEditor_Controller {	
	...
	protected function authCheck() {
		...
		$viewer->display(vtlib_getModuleTemplate('Ottocrat', 'OperationNotPermitted.tpl'));
		exit;
	}
	...
	protected function processSave($request) {
		...
		header('Location:'.Ottocrat_Request:: encryptLink(' index.php?module=ConfigEditor&action=index'));
	}
