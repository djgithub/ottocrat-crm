	...
	function vtlib_handler($moduleName, $eventType) {
		...
		global $adb,$mod_strings;
 		...
 		if($eventType == 'module.postinstall') {			
			...
			$adb->query("INSERT INTO ottocrat_settings_field (fieldid, blockid, name, iconpath, description, linkto) 
							VALUES (".$adb->getUniqueID('ottocrat_settings_field').", ".getSettingsBlockId($blockname).", '$name', '$icon', '$description', '".Ottocrat_Request:: encryptLink($links)."')");
 		} else if($eventType == 'module.disabled') {
		// TODO Handle actions when this module is disabled.
			$moduleInstance = Ottocrat_Module::getInstance('Tooltip');
