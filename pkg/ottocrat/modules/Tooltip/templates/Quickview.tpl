...
<tbody><tr>
	<td valign="top"><img src="{'showPanelTopLeft.gif'|@ottocrat_imageurl:$THEME}"></td>
	...
	<div align=center>
		...
		<tbody>
			<tr>
				<td rowspan="2" valign="top" width="50"><img src="{'quickview.png'|@ottocrat_imageurl:$THEME}" alt="{$MOD.LBL_USERS}" title="{$MOD.LBL_USERS}" border="0" height="48" width="48"></td>
    ...
    <td valign="top"><img src="{'showPanelTopRight.gif'|@ottocrat_imageurl:$THEME}"></td>
    </tr>
</tbody>
</table>
<br>
