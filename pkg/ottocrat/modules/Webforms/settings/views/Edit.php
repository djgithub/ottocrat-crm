...
Class Settings_Webforms_Edit_View extends Settings_Ottocrat_Index_View {
	...
	public function process(Ottocrat_Request $request) {
		...
		$recordStructure = Ottocrat_RecordStructure_Model::getInstanceFromRecordModel($recordModel, Ottocrat_RecordStructure_Model::RECORD_STRUCTURE_MODE_EDIT);
