...
Ottocrat_Detail_Js("Project_Detail_Js",{},{
	...
	registerStatusChangeEventForWidget : function(){
		...
		jQuery('[name="ticketstatus"],[name="projecttaskstatus"],[name="projecttaskprogress"]').on('change',function(e){
			...
			if(selectedStatus != "Select Status" && referenceModuleName == "HelpDesk"){
				statusCondition['ottocrat_troubletickets.status'] = selectedStatus;
				...
				statusCondition['ottocrat_projecttask.projecttaskstatus'] = selectedStatus;
				params['whereCondition'] = statusCondition;
			}
				...
				statusCondition['ottocrat_projecttask.projecttaskprogress'] = selectedStatus;
				params['whereCondition'] = statusCondition;
			}
