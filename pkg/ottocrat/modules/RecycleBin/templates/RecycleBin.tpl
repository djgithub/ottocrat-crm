...
{include file='Buttons_List.tpl'}
                                <div id="searchingUI" style="display:none;">
                                        ...
                                        <tr>
                                                <td align=center>
                                                <img src="{'searching.gif'|@ottocrat_imageurl:$THEME}" alt="{$APP.LBL_SEARCHING}"  title="{$APP.LBL_SEARCHING}">
                                                </td>
                                        </tr>
                                        </table>
...
<tr><td valign=top><img src="{'showPanelTopLeft.gif'|@ottocrat_imageurl:$THEME}"></td>
