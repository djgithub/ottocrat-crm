...
class ottocratCRMHandler extends SyncHandler {
        ...
        foreach ($referenceFieldDetails as $referenceFieldName => $referenceModuleDetails) {
            ...
            foreach ($records as $recordDetails) {
                ...
                if (!empty($referenceWsId)) {
                    ...
                    $webserviceObject = OttocratWebserviceObject::fromId($db, $referenceIdComp[0]);
    ...
    /**
     * Function to fillMandatory fields in ottocrat with given values
