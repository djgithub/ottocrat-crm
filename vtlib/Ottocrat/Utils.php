 ...
 * @package vtlib
 */
class Ottocrat_Utils {
    protected static $logFileName = 'ottocratmodule.log';
	...
	static function Log($message, $delimit=true) {
		global $Ottocrat_Utils_Log, $log;
		
		$log->debug($message);
		if(!isset($Ottocrat_Utils_Log) || $Ottocrat_Utils_Log == false) return;
	...
	static function CheckTable($tablename) {
		...
		$tablename = Ottocrat_Utils::SQLEscape($tablename);
