...
class Ottocrat_PDF_Generator {
	...
	function __construct() {
		$this->pdf = new Ottocrat_PDF_TCPDF(PDF_PAGE_ORIENTATION, PDF_UNIT, PDF_PAGE_FORMAT);
	...
	function createLastPage() {
		...
		if ($totalHeightFooter) {
			$this->footerFrame = new Ottocrat_PDF_Frame();
	...
	function createPage($isLastPage = false) {
		...
		if ($totalHeightHeader) {
			$this->headerFrame = new Ottocrat_PDF_Frame();
		...
		// ContentViewer
		$this->contentFrame = new Ottocrat_PDF_Frame();
