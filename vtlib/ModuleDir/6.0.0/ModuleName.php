...
include_once 'modules/Ottocrat/CRMEntity.php';

class ModuleName extends Ottocrat_CRMEntity {
	var $table_name = 'ottocrat_<modulename>';
	var $table_index= '<modulename>id';

	/**
	 * Mandatory table for supporting custom fields.
	 */
	var $customFieldTable = Array('ottocrat_<modulename>cf', '<modulename>id');

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	var $tab_name = Array('ottocrat_crmentity', 'ottocrat_<modulename>', 'ottocrat_<modulename>cf');
	...
	var $tab_name_index = Array(
		...
		'ottocrat_<modulename>' => '<modulename>id',
		'ottocrat_<modulename>cf'=>'<modulename>id');
