...
$organization_name = str_replace('.od1.ottocrat.com', '', $organization_name);
...
if (isset($_REQUEST['service'])) {
	...
	$cronTasks = array(Ottocrat_Cron::getInstance($_REQUEST['service']));
}
else {
	// Run all service
	$cronTasks = Ottocrat_Cron::listAllActiveInstances();
}
