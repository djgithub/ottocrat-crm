<?php /* Smarty version Smarty-3.1.7, created on 2015-10-27 12:15:24
         compiled from "C:\wamp\www\projects\ottocratcrm6.3\includes\runtime/../../layouts/vlayout\modules\Ottocrat\RecentActivities.tpl" */ ?>
<?php /*%%SmartyHeaderCode:12492562f6adcc4a1b9-00568667%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2900d431f20471fb61c9f046f6b1083f89343824' => 
    array (
      0 => 'C:\\wamp\\www\\projects\\ottocratcrm6.3\\includes\\runtime/../../layouts/vlayout\\modules\\Ottocrat\\RecentActivities.tpl',
      1 => 1443436061,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '12492562f6adcc4a1b9-00568667',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_562f6adceb407',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_562f6adceb407')) {function content_562f6adceb407($_smarty_tpl) {?>
...
</span><span class="pull-right"><p class="muted"><small title="<?php echo Ottocrat_Util_Helper::formatDateTimeIntoDayString($_smarty_tpl->tpl_vars['RECENT_ACTIVITY']->value->getParent()->get('createdtime'));?>
"><?php echo Ottocrat_Util_Helper::formatDateDiffInStrings($_smarty_tpl->tpl_vars['RECENT_ACTIVITY']->value->getParent()->get('createdtime'));?>
...
</span><span class="pull-right"><p class="muted"><small title="<?php echo Ottocrat_Util_Helper::formatDateTimeIntoDayString($_smarty_tpl->tpl_vars['RECENT_ACTIVITY']->value->getActivityTime());?>
"><?php echo Ottocrat_Util_Helper::formatDateDiffInStrings($_smarty_tpl->tpl_vars['RECENT_ACTIVITY']->value->getActivityTime());?>
...
?><?php if ($_smarty_tpl->tpl_vars['FIELDMODEL']->value&&$_smarty_tpl->tpl_vars['FIELDMODEL']->value->getFieldInstance()&&$_smarty_tpl->tpl_vars['FIELDMODEL']->value->getFieldInstance()->isViewable()&&$_smarty_tpl->tpl_vars['FIELDMODEL']->value->getFieldInstance()->getDisplayType()!='5'){?><div class='font-x-small updateInfoContainer'><i><?php echo vtranslate($_smarty_tpl->tpl_vars['FIELDMODEL']->value->getName(),$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
 ...
 <b style="white-space:pre;"><?php echo Ottocrat_Util_Helper::toOttocrat6SafeHTML($_smarty_tpl->tpl_vars['FIELDMODEL']->value->getDisplayValue(decode_html($_smarty_tpl->tpl_vars['FIELDMODEL']->value->get('prevalue'))));?>
 ...
 </b> ( <del><?php echo Ottocrat_Util_Helper::toOttocrat6SafeHTML($_smarty_tpl->tpl_vars['FIELDMODEL']->value->getDisplayValue(decode_html($_smarty_tpl->tpl_vars['FIELDMODEL']->value->get('prevalue'))));?>
...
&nbsp;<b style="white-space:pre;"><?php echo Ottocrat_Util_Helper::toOttocrat6SafeHTML($_smarty_tpl->tpl_vars['FIELDMODEL']->value->getDisplayValue(decode_html($_smarty_tpl->tpl_vars['FIELDMODEL']->value->get('postvalue'))));?>
...
</strong> <?php }?></span><span class="pull-right"><p class="muted"><small title="<?php echo Ottocrat_Util_Helper::formatDateTimeIntoDayString($_smarty_tpl->tpl_vars['RELATION']->value->get('changedon'));?>
"><?php echo Ottocrat_Util_Helper::formatDateDiffInStrings($_smarty_tpl->tpl_vars['RELATION']->value->get('changedon'));?>
