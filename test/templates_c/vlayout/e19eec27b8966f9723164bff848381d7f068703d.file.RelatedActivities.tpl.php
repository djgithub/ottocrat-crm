<?php /* Smarty version Smarty-3.1.7, created on 2015-10-27 12:15:18
         compiled from "C:\wamp\www\projects\ottocratcrm6.3\includes\runtime/../../layouts/vlayout\modules\Ottocrat\RelatedActivities.tpl" */ ?>
<?php /*%%SmartyHeaderCode:3633562f6ad603aaa7-09861679%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e19eec27b8966f9723164bff848381d7f068703d' => 
    array (
      0 => 'C:\\wamp\\www\\projects\\ottocratcrm6.3\\includes\\runtime/../../layouts/vlayout\\modules\\Ottocrat\\RelatedActivities.tpl',
      1 => 1444828055,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '3633562f6ad603aaa7-09861679',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_562f6ad62213a',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_562f6ad62213a')) {function content_562f6ad62213a($_smarty_tpl) {?>
...
</h4></span><span class="span4"><button class="btn pull-right addButton createActivity" data-url=<?php echo Ottocrat_Request::encryptLink("sourceModule=".($_smarty_tpl->tpl_vars['RECORD']->value->getModuleName())."&sourceRecord=".($_smarty_tpl->tpl_vars['RECORD']->value->getId())."&relationOperation=true");?>
 type="button"><strong><?php echo vtranslate('LBL_ADD',$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
...
"/><div class="row-fluid"><span class="span6"><strong title="<?php echo Ottocrat_Util_Helper::formatDateTimeIntoDayString(($_smarty_tpl->tpl_vars['START_DATE']->value)." ".($_smarty_tpl->tpl_vars['START_TIME']->value));?>
"><?php echo Ottocrat_Util_Helper::formatDateIntoStrings($_smarty_tpl->tpl_vars['START_DATE']->value,$_smarty_tpl->tpl_vars['START_TIME']->value);?>
