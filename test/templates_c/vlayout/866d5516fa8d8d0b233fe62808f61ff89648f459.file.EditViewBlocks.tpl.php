<?php /* Smarty version Smarty-3.1.7, created on 2015-10-25 12:10:18
         compiled from "C:\wamp\www\projects\ottocratcrm6.3\includes\runtime/../../layouts/vlayout\modules\Ottocrat\EditViewBlocks.tpl" */ ?>
<?php /*%%SmartyHeaderCode:27757562cc6aaad1dd4-74030592%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '866d5516fa8d8d0b233fe62808f61ff89648f459' => 
    array (
      0 => 'C:\\wamp\\www\\projects\\ottocratcrm6.3\\includes\\runtime/../../layouts/vlayout\\modules\\Ottocrat\\EditViewBlocks.tpl',
      1 => 1443436061,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '27757562cc6aaad1dd4-74030592',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_562cc6aae5aa9',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_562cc6aae5aa9')) {function content_562cc6aae5aa9($_smarty_tpl) {?>

<div class='container-fluid editViewContainer'><form class="form-horizontal recordEditView" id="EditView" name="EditView" method="post" action="index.php" enctype="multipart/form-data"><?php $_smarty_tpl->tpl_vars['WIDTHTYPE'] = new Smarty_variable($_smarty_tpl->tpl_vars['USER_MODEL']->value->get('rowheight'), null, 0);?><?php if (!empty($_smarty_tpl->tpl_vars['PICKIST_DEPENDENCY_DATASOURCE']->value)){?><input type="hidden" name="picklistDependency" value='<?php echo Ottocrat_Util_Helper::toSafeHTML($_smarty_tpl->tpl_vars['PICKIST_DEPENDENCY_DATASOURCE']->value);?>
...
<?php echo print_r($_smarty_tpl->tpl_vars['file']->value);?>
