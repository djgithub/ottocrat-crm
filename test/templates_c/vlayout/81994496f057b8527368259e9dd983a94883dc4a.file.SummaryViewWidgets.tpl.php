<?php /* Smarty version Smarty-3.1.7, created on 2015-10-27 12:15:19
         compiled from "C:\wamp\www\projects\ottocratcrm6.3\includes\runtime/../../layouts/vlayout\modules\Ottocrat\SummaryViewWidgets.tpl" */ ?>
<?php /*%%SmartyHeaderCode:17646562f6ad7df2637-44201881%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '81994496f057b8527368259e9dd983a94883dc4a' => 
    array (
      0 => 'C:\\wamp\\www\\projects\\ottocratcrm6.3\\includes\\runtime/../../layouts/vlayout\\modules\\Ottocrat\\SummaryViewWidgets.tpl',
      1 => 1445006215,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '17646562f6ad7df2637-44201881',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_562f6ad7f006e',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_562f6ad7f006e')) {function content_562f6ad7f006e($_smarty_tpl) {?>
...
" data-url=<?php ob_start();?><?php echo htmlspecialchars_decode($_smarty_tpl->tpl_vars['DETAIL_VIEW_WIDGET']->value->getUrl());?>
...
?><?php if ($_smarty_tpl->getVariable('smarty')->value['foreach']['count']['index']%2!=0){?><div class="summaryWidgetContainer"><div class="widgetContainer_<?php echo $_smarty_tpl->getVariable('smarty')->value['foreach']['count']['index'];?>
" data-url=<?php ob_start();?><?php echo htmlspecialchars_decode($_smarty_tpl->tpl_vars['DETAIL_VIEW_WIDGET']->value->getUrl());?>
<?php $_tmp2=ob_get_clean();?><?php echo Ottocrat_Request::encryptLink($_tmp2);?>
 data-name="<?php echo $_smarty_tpl->tpl_vars['DETAIL_VIEW_WIDGET']->value->getLabel();?>
"><div class="widget_header row-fluid"><span class="span8 margin0px"><h4><?php echo vtranslate($_smarty_tpl->tpl_vars['DETAIL_VIEW_WIDGET']->value->getLabel(),$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
