<?php /* Smarty version Smarty-3.1.7, created on 2015-10-27 14:22:00
         compiled from "C:\wamp\www\projects\ottocratcrm6.3\includes\runtime/../../layouts/vlayout\modules\Settings\Ottocrat\Index.tpl" */ ?>
<?php /*%%SmartyHeaderCode:28219562cb316c83126-21116495%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '6841f383ca465df5c7c2d42951360353f1e76a11' => 
    array (
      0 => 'C:\\wamp\\www\\projects\\ottocratcrm6.3\\includes\\runtime/../../layouts/vlayout\\modules\\Settings\\Ottocrat\\Index.tpl',
      1 => 1445955716,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '28219562cb316c83126-21116495',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_562cb316daa97',
  'variables' => 
  array (
    'MODULE' => 0,
    'USERS_COUNT' => 0,
...
<?php if ($_valid && !is_callable('content_562cb316daa97')) {function content_562cb316daa97($_smarty_tpl) {?>
...
</h3></div><hr><div class="row-fluid"><span class="span4 settingsSummary"><a href="<?php echo Ottocrat_Request::encryptLink('index.php?module=Users&parent=Settings&view=List');?>
"><h2 style="font-size: 44px" class="summaryCount"><?php echo $_smarty_tpl->tpl_vars['USERS_COUNT']->value;?>
</h2><p class="summaryText" style="margin-top:20px;"><?php echo vtranslate('LBL_ACTIVE_USERS',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</p></a></span><span class="span4 settingsSummary"><a href="<?php echo Ottocrat_Request::encryptLink("index.php?module=Workflows&parent=Settings&view=List");?>
"><h2 style="font-size: 44px" class="summaryCount"><?php echo $_smarty_tpl->tpl_vars['ACTIVE_WORKFLOWS']->value;?>
</h2><p class="summaryText" style="margin-top:20px;"><?php echo vtranslate('LBL_WORKFLOWS_ACTIVE',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</p></a></span><span class="span4 settingsSummary"><a href="<?php echo Ottocrat_Request::encryptLink("index.php?module=ModuleManager&parent=Settings&view=List");?>
"><h2 style="font-size: 44px" class="summaryCount"><?php echo $_smarty_tpl->tpl_vars['ACTIVE_MODULES']->value;?>
