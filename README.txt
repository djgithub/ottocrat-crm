####################################################
ottocrat CRM 4.2 Patch 2
Sep 15, 2005
####################################################

We are pleased to announce the consolidated patch for ottocrat CRM 4.2. This release includes many code contributions from ottocrat community and bug fixes!

******************************************
I. Code Contributions by ottocrat Community
******************************************

Thanks to Bela, Fredy, JLee, MikeCrowe, and Sholmi for their valuable contributions to the ottocrat CRM development. 

Following contributions were made at ottocrat Discussions under "ottocrat CRM - Code Contributions" forum:

1. T2025  - 2 bugs - JLee (Same as P8180 in ottocrat Discussions " Little typo in function get_lead_feild_options")
...
-----------------------------------
B. ottocrat Discussions - Bug Tracker
-----------------------------------
...
45. Forum Topic ID 1753: OttocratCRM 4.0 Character causing troubles
...
We are pleased to announce the latest version of ottocrat CRM. This release includes many new features and few bug fixes!
...
*****************
  ...
  * Group/Shared calendar to plan meetings with ottocrat CRM users without time conflicts

  * UI enhancements related to overdue tasks in Activities list view 

2. Lead Management

 * Capture leads directly from your Web site to ottocrat CRM
 ...
 *  Procure products from the available Vendors/Manufacturers/Resellers list in ottocrat CRM
 ...
 * Update Articles/FAQ in ottocrat CRM as based customer suggestions & comments
 ...
 * Seamless integration between incoming E-mail messages and the corresponding contacts in ottocrat CRM with a single click
 ...
 * Populate ottocrat CRM user related fields in E-mail templates

 * Export E-mail messages into CSV file

 * Fetch inbound E-mails and associate to the contacts or create E-mails directly into ottocrat CRM
...
15. In a Product Detail View if 'Add to Price Book' hyperlink is clicked and if no Price Book is present in the list, and if 'Add to Product' is selected, ottocrat Home page will be displayed. 
...
NOTE: For more details about ottocrat CRM 4.2 Release Notes, Please refer to the following URL:

http://www.ottocrat.com/wiki/index.php/Ottocrat_CRM_4_2_Release_Notes
 
#######################

ottocrat CRM 4.2 Alpha
May 31, 2005
...
******************************************************************************************
Note: ottocrat CRM 4.2 Alpha is only for testing and can not be used for production purpose.

Please post Bugs at the following URL:

ottocrat Discussions: http://www.ottocrat.com/discussions/viewforum.php?f=12
...
We are pleased to announce the latest version of ottocrat CRM. This release
...
We are pleased to announce the latest version of ottocrat CRM. This release includes several new features and numerous bug fixes!
...
3. Microsoft Office Plug-in to create mail merge templates in Microsoft Word and create on-the-fly documents with customer specific data in ottocrat CRM

4. Mozilla Thunderbird Plug-in to add E-mail messages and addresses from Thunderbird to ottocrat CRM

5. E-mail notifications to ottocrat CRM users as well as customers instantly as well as periodically
...
We have also provided the following features requested in Sourceforge.net and ottocrat Discussions:
...
* We have tested ottocrat CRM 4 in MySQL database software. Though we didn't tested in other database software, we feel it should work.
...
We have fixed the following issues reported in Sourceforge.net and ottocrat Discussions:
...
29. ottocrat DIscussions: RC1 - Accounts : Please show first name under contacts - by eberled
...
37. Ottocrat CRM 4 (RC1) - Save Record Failure -
...
43. ottocrat Outlook Plugin 4.0.1 beta Release - by adrian
...
48. ottocrat v4 - How do you add a manufacturer? - 

49. Contacts in ottocrat Outlook related - Maarten
...
1. 1111896: Outlook raises a security alert when adding email with ottocrat Outlook Plug-in
...
We are pleased to announce the latest version of ottocrat CRM.
...
6. Add/Sync Email attachments using ottocrat Outlook Plug-in from Microsoft(R) Outlook(R) to ottocrat CRM

7. Add/Sync tasks using ottocrat Outlook Plug-in from Microsoft(R) Outlook(R) to ottocrat CRM
...
14. 1089627 - Problem with ottocrat. 25 Character email limit
...
h) ottocrat Outlook Plug-in in server side fixes related to performance improvement.
...
a) Support for accessing ottocrat CRM server from Microsoft Outlook behind Proxy settings

b) Synchronize customer specific tasks in between Microsft Outlook and ottocrat CRM.

c) Integrated Message Boards with ottocrat CRM, which can be used to share customer knowledge among CRM service users.

---------------------

ottocrat CRM 3.0 Beta
October 7, 2004
...
a) Released ottocrat Outlook Plug-in, business productivity enhancement utility for Microsoft Outlook users. It is an open source project covered under ottocrat Public License 1.0 based on Mozilla Public License 1.1. 
...
Sales reps can import leads to ottocrat CRM from external sources, such as Microsoft Outlook, 
...
We gratefully acknowledge the contribution made by SugarCRM, and we intend to actively participate and lead in bringing this vision of affordable enterprise applications, but we make it clear that ottocrat is not affiliated with nor is endorsed by SugarCRM.

The team at ottocrat CRM is pleased to announce the v1.0 the first release of ottocrat CRM Open Source project.

This first release of ottocrat.Sales is best suited for small sales forces.  If
you're looking to manage the basics of sales deals where every user can see
all of the data in the system, then ottocrat.Sales v1.0 is right for you.  Over the next few months, we will be building out ottocrat.Sales to meet the needs of larger, multi-national sales forces that need features like forecasting, data access permissions and internationalization.

Please feel free to send your valuable comments to contact@ottocrat.com so that we can have a better CRM product at free of cost. Check out our website at http://www.ottocrat.com for support forums, detailed product information, our future plan and much more.

-=Features=-
We have incorporated the following features in this release based on SugarCRM. 

Opportunities
ottocrat.Sales provides a complete, yet easy-to-use Opportunities module.  From deal size to each contact�s role, from listing the competitors to tracking the lead source, sales reps can easily manage each sales opportunity to completion.  
...
Managing your customer interactions is at the heart of a sales automation application. ottocrat.Sales provides a simple and clean set of tools for quickly tracking tasks, phone calls, emails and meetings. 
