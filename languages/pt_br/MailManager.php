...
$languageStrings = Array(
    ...
    'LBL_MODULE_DESCRIPTION' => "O Gestor de Mensagens é um cliente de e-mail integrado, que permite aos Usuários executar ações relacionadas com o CRM quando uma mensagem é recebida. Através dele é possível criar Leads, Contatos, Organizações, Chamados e Tarefas a partir dos e-mails recebidos em sua Caixa de Entrada. Quando o e-mail do remetente é coincide com o cadastrado no ottocrat CRM, você pode realizar outras ações, tais como: Anexar o E-mail, Adicionar uma Tarefa, Comentário e Chamado. Alem disso, você pode gerenciar a composição, respostas, encaminhamento de e-mails etc.",
