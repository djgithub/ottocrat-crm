...
/**
 * Description of OttocratLineItemMeta
 */
class OttocratLineItemMeta extends OttocratCRMActorMeta {
	...
	private function getTaxLabelFromName($name){
		...
		$sql = 'SELECT * FROM ottocrat_inventorytaxinfo WHERE taxname=? AND deleted=0';
		$params = array($name);
