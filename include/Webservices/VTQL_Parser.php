...
#line 451 "e:\workspace\nonadmin\pkg\ottocrat\extensions\Webservices\VTQL_parser.y"
class VTQL_Parser#line 102 "e:\workspace\nonadmin\pkg\ottocrat\extensions\Webservices\VTQL_parser.php"
{
...
Array ( 
	...
	[tableName] => ottocrat_crmentity,ottocrat_contactdetails,ottocrat_contactaddress,ottocrat_contactsubdetails,ottocrat_contactscf,ottocrat_customerdetails 
...
if($firstTable!=$table){
	if(!isset($tabNameIndex[$table]) && $table == "ottocrat_crmentity"){
