...
require_once 'include/Webservices/OttocratCRMActorMeta.php';
class OttocratActorOperation extends WebserviceEntityOperation {
	...
	protected function getMetaInstance(){
		if(empty(WebserviceEntityOperation::$metaCache[$this->webserviceObject->getEntityName()][$this->user->id])){
			WebserviceEntityOperation::$metaCache[$this->webserviceObject->getEntityName()][$this->user->id]  
					= new OttocratCRMActorMeta($this->entityTableName,$this->webserviceObject,$this->pearDB,$this->user);
		}
	...
	protected function getActorTables(){
		...
		$sql = 'select table_name, webservice_entity_id from ottocrat_ws_entity_tables';
	...
	public function __create($elementType,$element){
		...
		//Insert into group ottocrat_table
