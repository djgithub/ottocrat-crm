...
function expandRecord($table,$log)
{
    ...
    //ottocrat_products table
    if( $table == "ottocrat_products" )
    ...
    //ottocrat_activity table
    elseif( $table == "ottocrat_activity")
	...
	//ottocrat_producttaxrel
    elseif( $table == "ottocrat_producttaxrel")
	$subfields = array ( "productid", "taxid", "taxpercentage");

	//ottocrat_inventorytaxinfo
	elseif( $table == "ottocrat_inventorytaxinfo")
	$subfields = array ( "taxid", "taxname", "taxlabel", "percentage", "deleted");

	//ottocrat_role2picklist
	elseif( $table == "ottocrat_role2picklist")
	$subfields = array ( "roleid", "picklistid", "sortid");

	//ottocrat_contactdetails
	elseif( $table == "ottocrat_contactdetails")
	...
	//ottocrat_crmentity
	elseif( $table == "ottocrat_crmentity")
	...
	//ottocrat_salesorder
	elseif( $table == "ottocrat_salesorder")
	...
	//ottocrat_seactivityrel
	elseif( $table == "ottocrat_seactivityrel")
	$subfields = array("crmid", "activityid");

	//ottocrat_cntactivityrel
	elseif( $table == "ottocrat_cntactivityrel")
	$subfields = array("contactid", "activityid");

	//ottocrat_purchaseorder
	elseif( $table == "ottocrat_purchaseorder")
	...
	//ottocrat_leaddetails
	elseif( $table == "ottocrat_leaddetails")
	...
	//ottocrat_campaignleadrel
	elseif( $table == "ottocrat_campaignleadrel")
	$subfields = array("campaignid", "leadid");

	//ottocrat_pricebook
	elseif( $table == "ottocrat_pricebook")
