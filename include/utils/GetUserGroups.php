...
class GetUserGroups { 
	...
	function getAllUserGroups($userid)
	{
		...
		$query="select * from ottocrat_users2group where userid=?";
		...
		//Retreiving from the ottocrat_user2role
		$query="select * from ottocrat_group2role where roleid=?";
		...
		$query="select * from ottocrat_group2rs where roleandsubid in (". generateQuestionMarks($parentRolelist) .")";
