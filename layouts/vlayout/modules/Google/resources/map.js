    ...
    jQuery.Class("MapView",{
        ...
        showMap:function(){
         ...
         //   MapView.url+='&recordid='+record+'&source_module='+module;
            MapView.url='index.php?';
            jQuery.ajax({
                url:MapView.url
            }).done(function(res){
