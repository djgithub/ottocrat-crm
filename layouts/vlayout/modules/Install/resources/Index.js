	...
	registerEventForStep3 : function() {
		...
		jQuery('input[name="step4"]').on('click', function(e){
			...
			if(elements.length > 0) {
				var msg = "Some of the PHP Settings do not meet the recommended values. This might affect some of the features of ottocrat CRM. Are you sure, you want to proceed?";
				if(confirm(msg)) {
