...
<div class="row-fluid main-container">
	<div class="inner-container">
		...
		<form class="form-horizontal" name="step2" method="get" action="index.php">
			...
			<div class="span12">
				...
				<div class="lic-scroll">
					<p>PLEASE READ THE FOLLOWING LICENSE AGREEMENT CAREFULLY. ANY USE OF SOFTWARE DOWNLOADED OR ORDERED FROM OTTOCRAT IS PERMITTED ONLY UNDER LICENSE WITH OTTOCRAT. 
						BY DOWNLOADING THIS SOFTWARE YOU AGREE TO BE BOUND BY THE TERMS OF THIS LICENSE AGREEMENT. 
					</p>
					<strong>
					<p style="font-size:15px;font-family:Verdana;">Ottocrat Public Licence</p>
					</strong>
					<br>
					The ottocrat Public License Version 1.2 is based on the Mozilla Public License Version 1.1 with the additional terms in Exhibit B. The original Mozilla Public License 1.1 can be found at: http://www.mozilla.org/MPL/MPL-1.1.html
					<br>
					ottocrat Public License
					Version 1.2
					<br><br>
					Copyright (c) 2004-2013 www.ottocrat.com All rights reserved.
					<br><br>
					<!--
									PLEASE READ THE FOLLOWING LICENSE AGREEMENT CAREFULLY. ANY USE OF SOFTWARE DOWNLOADED OR ORDERED FROM OTTOCRAT IS PERMITTED ONLY UNDER LICENSE WITH OTTOCRAT. BY DOWNLOADING THIS SOFTWARE YOU AGREE TO BE BOUND BY THE TERMS OF THIS LICENSE AGREEMENT.
					--><ol>
					<li> Definitions.
						<dl>
     ...
     ottocrat may publish revised and/or new versions of the License from time to time. Each version will be given a distinguishing version number. 

						</dd><br><dd>      6.2. Effect of New Versions.
      Once Covered Code has been published under a particular version of the License, You may always continue to use it under the terms of that version. You may also choose to use such Covered Code under the terms of any subsequent version of the License published by ottocrat. No one other than ottocrat has the right to modify the terms applicable to Covered Code created under this License.

						</dd><br><dd>    6.3. Derivative Works.
     If You create or use a modified version of this License (which you may only do in order to apply it to code which is not already Covered Code governed by this License), You must (a) rename Your license so that the phrases "ottocrat'or any confusingly similar phrase do not appear in your license (except to note that your license differs from this License) and (b) otherwise make it clear that Your version of the license contains terms which differ from the ottocrat Public License. (Filling in the name of the Initial Developer, Original Code or Contributor in the notice described in Exhibit A shall not of themselves be deemed to be modifications of this License.)
						</dd></dl><br>
					</li><li>
					...
					EXHIBIT A -ottocrat Public License.
					<br><br>
					"The contents of this file are subject to the ottocrat Public License Version 1.1 (the "License"); you may not use this file except in compliance with the License."
					<br><br>
					Software distributed under the License is distributed on an "AS IS" basis, WITHOUT WARRANTY OF ANY KIND, either express or implied. See the License for the specific language governing rights and limitations under the License.
					<br><br>
					The Original Code is ottocrat.
					<br><br>
					The Initial Developer of the Original Code is ottocrat. Portions created by  ottocrat are Copyright (C) www.ottocrat.com. All Rights Reserved.
					<br><br>
					Contributor(s): ______________________________________.
					<br><br>
					[NOTE: The text of this Exhibit A may differ slightly from the text of the notices in the Source Code files of the Original Code. You should use the text of this Exhibit A rather than the text found in the Original Code Source Code for Your Modifications.]
					<br><br>
					EXHIBIT B - Ottocrat CRM and Logo
					<br><br>
					This License does not grant any rights to use the trademarks "Ottocrat" and "Ottocrat CRM" and "Ottocrat" logos even if such marks are included in the Original Code or Modifications.
					<br><br>
				</div>
				</div>
			</div>
