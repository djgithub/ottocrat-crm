				...
				<div id="scheduleBox" class='well contentsBackground {if $SCHEDULEDREPORTS->get('scheduleid') eq ''} hide {/if}'>
					...
					<div class='row-fluid {if $scheduleid neq 2} hide {/if}' id='scheduledWeekDay' style='padding:5px 0px;'>
						...
						<div class='span4'>
							...
							<select style='width:230px;' multiple class='chosen' data-validation-engine="validate[required,funcCall[Ottocrat_Base_Validator_Js.invokeValidation]]" name='schdayoftheweek' id='schdayoftheweek'>
                        ...
                        <div class='row-fluid {if $scheduleid neq 3} hide {/if}' id='scheduleMonthByDates' style="padding:5px 0px;">
                            ...
                            <div class='span4'>
                                ...
                                <select style="width: 281px !important;" multiple class="chosen-select span6" data-validation-engine="validate[required,funcCall[Ottocrat_Base_Validator_Js.invokeValidation]]" name='schdayofthemonth' id='schdayofthemonth' >
                            ...
                            <div class='span6'>
                                <div class='input-append row-fluid'>
                                    <div class='row-fluid date'>
                                        ...
                                        <input style='width: 185px;' type="text" class="dateField  span6" id="schdate" name="schdate" value="{$specificDate1}" data-date-format="{$CURRENT_USER->date_format}" data-validation-engine="validate[ required,funcCall[Ottocrat_Base_Validator_Js.invokeValidation]]"/>
                    ...
                    <div class='row-fluid {if $scheduleid neq 4} hide {/if}' id='scheduleAnually' style='padding:5px 0px;'>
                        ...
                        <div class='span2'>
                            ...
                            <div>
                                ...
                                <select multiple class="chosen-select" id='annualDates' name='schannualdates' data-validation-engine="validate[required,funcCall[Ottocrat_Base_Validator_Js.invokeValidation]]">
                    ...
                    <div class='row-fluid' id='scheduledTime' style='padding:5px 0px 10px 0px;'>
                        ...
                        <div class='span4' id='schtime'>
                            <div class="input-append time">
                                <input type='text' class='timepicker-default input-small' data-format='24' name='schtime' value="{$SCHEDULEDREPORTS->get('schtime')}" data-validation-engine="validate[required,funcCall[Ottocrat_Base_Validator_Js.invokeValidation]]"/>
                    ...
                    <div class='row-fluid' id='recipientsList' style='padding:5px 0px 10px 0px;'>
                        ...
                        <div class='span4'>
                            ...
                            <select multiple class="chosen-select span6" id='recipients' name='recipients' data-validation-engine="validate[required,funcCall[Ottocrat_Base_Validator_Js.invokeValidation]]" style="width: 281px !important;">
                    ...
                    <div class='row-fluid' id='specificemailsids' style='padding:5px 0px 10px 0px;'>
                        ...
                        <div class='span4'>
                            ...
                            <input id="specificemails" style="width: 281px !important;" class="span6" type="text" value="{$specificemailids}" name="specificemails" data-validation-engine="validate[funcCall[Ottocrat_MultiEmails_Validator_Js.invokeValidation]]"></input>
                        </div>
                    </div>
