...
Reports_Detail_Js("Reports_ChartDetail_Js",{
	...
	registerEventForChartGeneration : function() {
		...
		try {
			...
			jQuery('#chartcontent').trigger(Ottocrat_Widget_Js.widgetPostLoadEvent);
		} catch(error) {
			console.log("error");
			console.log(error);
...
Ottocrat_Pie_Widget_Js('Report_Piechart_Js',{},{
...
Ottocrat_Barchat_Widget_Js('Report_Verticalbarchart_Js', {},{
