...
Reports_Edit_Js("Reports_Edit2_Js",{},{
	...
	registerLineItemCalculationLimit : function() {
		...
		if(jQuery.inArray(primaryModule, inventoryModules) !== -1 || secondaryIsInventory) {
			jQuery('.CalculationFields').on('change', 'input[type="checkbox"]', function(e) {
				...
				var reg = new RegExp(/cb:ottocrat_inventoryproductrel*/);
				var attr = element.is(':checked');
				var moduleCalculationFields = jQuery('.CalculationFields input[type="checkbox"]').not('[value^="cb:ottocrat_inventoryproductrel"]');
				var lineItemCalculationFields = jQuery('.CalculationFields').find('[value^="cb:ottocrat_inventoryproductrel"]');
	...
	registerLineItemCalculationLimitOnLoad : function() {
		var moduleCalculationFields = jQuery('.CalculationFields input[type="checkbox"]').not('[value^="cb:ottocrat_inventoryproductrel"]');
		var lineItemFields = jQuery('.CalculationFields').find('[value^="cb:ottocrat_inventoryproductrel"]');
