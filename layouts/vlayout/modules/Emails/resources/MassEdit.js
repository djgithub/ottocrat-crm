...
Ottocrat_Email_Validator_Js("Ottocrat_To_Email_Validator_Js", {
	...
	invokeValidation: function(field, rules, i, options){
		var toEmailInstance = new Ottocrat_To_Email_Validator_Js();
...
jQuery.Class("Emails_MassEdit_Js",{},{
	...
	getckEditorInstance : function(){
		if(this.ckEditorInstance == false){
			this.ckEditorInstance = new Ottocrat_CkEditor_Js();
		}
	...
	fileAfterSelectHandler : function(element, value, master_element){
		...
		if(totalAttachmentsSize > maxUploadSize){
			Ottocrat_Helper_Js.showPnotify(app.vtranslate('JS_MAX_FILE_UPLOAD_EXCEEDS'));
