				...
				<span class="span4 textAlignCenter">
					<span class="muted">
						{if $RECORD->get('email_flag') eq "SAVED"}
							...
							<span><small><em>&nbsp;{Ottocrat_Util_Helper::formatDateTimeIntoDayString($RECORD->get('createdtime'))}</em></small></span>
                                                {elseif $RECORD->get('email_flag') eq "MailManager"} 
                                                        ...
                                                        <span><small><em>&nbsp;{Ottocrat_Util_Helper::formatDateTimeIntoDayString($MAIL_DATE)}</em></small></span> 
						{else}
                            ...
                            <span><small><em>&nbsp;{Ottocrat_Util_Helper::formatDateTimeIntoDayString($SEND_TIME)}</em></small></span>
						{/if}
					</span>
				</span>
			</div>
