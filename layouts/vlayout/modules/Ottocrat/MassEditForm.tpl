...
<div id="massEditContainer" class='modelContainer'>
	...
	<form class="form-horizontal" id="massEdit" name="MassEdit" method="post" action="index.php">
		{if !empty($PICKIST_DEPENDENCY_DATASOURCE)}
			<input type="hidden" name="picklistDependency" value='{Ottocrat_Util_Helper::toSafeHTML($PICKIST_DEPENDENCY_DATASOURCE)}' />
		{/if}
        ...
        <input type="hidden" id="massEditFieldsNameList" data-value='{Ottocrat_Util_Helper::toSafeHTML(ZEND_JSON::encode($MASS_EDIT_FIELD_DETAILS))}' />
