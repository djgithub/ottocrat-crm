                    ...
                    <span class="btn-group">
                            ...
                            <ul class="dropdown-menu widgetsList pull-right" style="min-width:100%;text-align:left;">
                                    ...
                                    {foreach from=$WIDGETS item=WIDGET}
                                            ...
                                            {else}
                                            <li>
                                                    <a onclick="Ottocrat_DashBoard_Js.addWidget(this, '{$WIDGET->getUrl()}')" href="javascript:void(0);"
                                    ...
                                    <li class="divider"></li>
                                    <li>
                                            <a onclick="Ottocrat_DashBoard_Js.addMiniListWidget(this, '{$MINILISTWIDGET->getUrl()}')" href="javascript:void(0);"
                                    ...
                                    <li>
                                            <a onclick="Ottocrat_DashBoard_Js.addNoteBookWidget(this, '{$NOTEBOOKWIDGET->getUrl()}')" href="javascript:void(0);"
