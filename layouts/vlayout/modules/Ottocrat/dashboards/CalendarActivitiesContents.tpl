...
<div>
	...
	<div>
		...
		<div>
			...
			<p class='pull-right muted' style='margin-top:5px;padding-right:5px;'><small title="{Ottocrat_Util_Helper::formatDateTimeIntoDayString("$START_DATE $START_TIME")} {vtranslate('LBL_TO')} {Ottocrat_Util_Helper::formatDateTimeIntoDayString("$DUE_DATE $DUE_TIME")}">{Ottocrat_Util_Helper::formatDateDiffInStrings("$START_DATE $START_TIME")}</small></p>
