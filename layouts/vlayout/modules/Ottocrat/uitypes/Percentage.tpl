...
<div class="input-append">
	<input id="{$MODULE}_editView_fieldName_{$FIELD_MODEL->get('name')}" type="number" class="input-medium" min="0" max="100" data-validation-engine="validate[{if $FIELD_MODEL->isMandatory() eq true} required,{/if}funcCall[Ottocrat_Base_Validator_Js.invokeValidation]]" name="{$FIELD_MODEL->getFieldName()}"
