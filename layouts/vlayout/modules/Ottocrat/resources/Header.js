...
jQuery.Class("Ottocrat_Header_Js", {
    ...
    getInstance: function() {
        ...
        this.self = new Ottocrat_Header_Js();
        return this.self;
    }
}, {
    menuContainer: false,
    ...
    getQuickCreateForm: function(url, moduleName, params) {
        ...
        if ((!params.noCache) || (typeof (params.noCache) == "undefined")) {
            if (typeof Ottocrat_Header_Js.quickCreateModuleCache[moduleName] != 'undefined') {
                aDeferred.resolve(Ottocrat_Header_Js.quickCreateModuleCache[moduleName]);
        ...
        AppConnector.request(requestParams).then(function(data) {
            if ((!params.noCache) || (typeof (params.noCache) == "undefined")) {
                Ottocrat_Header_Js.quickCreateModuleCache[moduleName] = data;
            }
...
//        }
    ...
    registerCalendarButtonClickEvent: function() {
        ...
        var ottocratDateFormat = app.convertToDatePickerFormat(dateFormat);
    ...
    handleQuickCreateData: function(data, params) {
        ...
        app.showModalWindow(data, function(data) {
            ...
            var editViewInstance = Ottocrat_Edit_Js.getInstanceByModuleName(moduleName);
        ...
        form.on('submit', function(e) {
            ...
            if (typeof form.data('submit') != "undefined") {
                ...
                if (!(recordPreSaveEvent.isDefaultPrevented())) {
                    ...
                    var moduleInstance = Ottocrat_Edit_Js.getInstanceByModuleName(module);
                    ...
                    targetInstance.quickCreateSave(form).then(
                            function(data) {
                                ...
                                if((module == parentModule) && (viewname=="List")){ 
                                    var listinstance = new Ottocrat_List_Js(); 
    ...
    labelSearch: function(currentTarget) {
        ...
        var basicSearch = new Ottocrat_BasicSearch_Js();
    ...
    registerEvents: function() {
		...
		if(jQuery.browser.msie && jQuery.browser.version < 9.0) {
			if(app.getCookie('oldbrowser') != 'true') {
				...
				window.location.href = 'layouts/vlayout/modules/Ottocrat/browsercompatibility/Browser_compatibility.html';
			}
		}

        jQuery('#globalSearch').click(function() {
            var advanceSearchInstance = new Ottocrat_AdvanceSearch_Js();
		...
		$(document).ajaxComplete(function() {
			 Ottocrat_Header_Js.getInstance().adjustContentHeight();
		});
...
jQuery(document).ready(function() {
    ...
    Ottocrat_Header_Js.getInstance().registerEvents();
