...
jQuery.Class("Ottocrat_RelatedList_Js",{},{
            ...
            AppConnector.request(url).then(
				function(data){
					if(data){
                             ...
                             var params = {
                                        ...
                                        AppConnector.request(params).then(function(data){
                                            ...
                                            if(data['result'].created){
                                                ...
                                                Ottocrat_Detail_Js.reloadRelatedList();
                                            }
                                        });
                         });
                    });
                        ...
                        progressIndicatorInstance.hide();
                        Ottocrat_Helper_Js.showPnotify(app.vtranslate('JS_NO_EDIT_PERMISSION',"Calendar"));
                    }
				});
    },
                ...
                var params = {
                            ...
                            AppConnector.request(params).then(function(data){
                                if(data['error']){
                                    ...
                                    Ottocrat_Helper_Js.showPnotify(param);
                                }
