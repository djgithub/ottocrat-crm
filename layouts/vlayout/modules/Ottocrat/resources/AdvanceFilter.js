...
jQuery.Class("Ottocrat_AdvanceFilter_Js",{
	
	getInstance: function(container){
		var module = app.getModuleName();
		var moduleClassName = module+"_AdvanceFilter_Js";
		var fallbackClassName = "Ottocrat_AdvanceFilter_Js";
	...
	loadFieldSpecificUi : function(fieldSelect) {
		...
		var fieldModel = Ottocrat_Field_Js.getInstance(fieldInfo,moduleName);
	...
	addValidationToFieldIfNeeded : function(selectFieldElement) {
		...
		if(this.isFieldSupportsValidation(selectFieldElement)) {
			...
			fieldSpecificElement.addClass('validate[funcCall[Ottocrat_Base_Validator_Js.invokeValidation]]')
								.attr('data-validation-engine','validate[funcCall[Ottocrat_Base_Validator_Js.invokeValidation]]')
								.attr('data-fieldinfo', JSON.stringify(selectedOption.data('fieldinfo')));
            if(typeof validator!='undefined') {
                fieldSpecificElement.attr('data-validator',validator);
            }
		}else{
			fieldSpecificElement.removeClass('validate[funcCall[Ottocrat_Base_Validator_Js.invokeValidation]]')
...
Ottocrat_Field_Js('AdvanceFilter_Field_Js',{},{
...
Ottocrat_Picklist_Field_Js('AdvanceFilter_Picklist_Field_Js',{},{
...
Ottocrat_Multipicklist_Field_Js('AdvanceFilter_Multipicklist_Field_Js',{},{
...
Ottocrat_Owner_Field_Js('AdvanceFilter_Owner_Field_Js',{},{
...
Ottocrat_Date_Field_Js('AdvanceFilter_Date_Field_Js',{},{
	/**
