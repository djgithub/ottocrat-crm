...
jQuery.Class('Ottocrat_Widget_Js',{

	widgetPostLoadEvent : 'Vtiget.Dashboard.PostLoad',
	widgetPostRefereshEvent : 'Ottocrat.Dashboard.PostRefresh',
	...
	getInstance : function(container, widgetName, moduleName) {
		...
		var fallbackClass = window["Ottocrat_"+widgetClassName+"_Widget_Js"];

		var basicClass = Ottocrat_Widget_Js;
	...
	refreshWidget : function() {
		...
		AppConnector.request(params).then(
			function(data){
				...
				contentContainer.html(data).trigger(Ottocrat_Widget_Js.widgetPostRefereshEvent);
			},
			function(){
				refreshContainer.progressIndicator({'mode': 'hide'});
			}
	...
	registerWidgetPostLoadEvent : function(container) {
		var thisInstance = this;
		container.on(Ottocrat_Widget_Js.widgetPostLoadEvent, function(e) {
	...
	registerWidgetPostRefreshEvent : function(container) {
		var thisInstance = this;
		container.on(Ottocrat_Widget_Js.widgetPostRefereshEvent, function(e) {
...
Ottocrat_Widget_Js('Ottocrat_History_Widget_Js', {}, {
...
Ottocrat_Widget_Js('Ottocrat_Funnel_Widget_Js',{},{
...
Ottocrat_Widget_Js('Ottocrat_Pie_Widget_Js',{},{
...
Ottocrat_Widget_Js('Ottocrat_Barchat_Widget_Js',{},{
...
Ottocrat_Widget_Js('Ottocrat_MultiBarchat_Widget_Js',{
...
Ottocrat_Widget_Js('Ottocrat_Minilist_Widget_Js', {}, {
...
Ottocrat_Widget_Js('Ottocrat_Tagcloud_Widget_Js',{},{
...
/* Notebook Widget */
Ottocrat_Widget_Js('Ottocrat_Notebook_Widget_Js', {
