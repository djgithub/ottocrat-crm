 ...
 * All Rights Reserved.
 *************************************************************************************/
jQuery.Class("Ottocrat_Popup_Js",{
    ...
    getInstance: function(){
		...
		var fallbackClassName = Ottocrat_Popup_Js;
	...
	show : function(urlOrParams, cb, windowName, eventName, onLoadCb){
		...
		if(typeof cb != 'undefined') {
		 ...
		 if(typeof onLoadCb == 'function') {
			jQuery.windowMsg('Ottocrat.OnPopupWindowLoad.Event', function(data){
				onLoadCb(data);
            })
        }
	...
	getPageRecords : function(params){
		...
		Ottocrat_BaseList_Js.getPageRecords(params).then(
				function(data){
