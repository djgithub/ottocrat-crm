...
Ottocrat_BasicSearch_Js("Ottocrat_AdvanceSearch_Js",{
	...
	getAdvanceSearch : function() {
		...
		//Exists in the cache
		if(searchModule in Ottocrat_AdvanceSearch_Js.cache) {
			aDeferred.resolve(Ottocrat_AdvanceSearch_Js.cache[searchModule]);
			return aDeferred.promise();
		}
        
        //if you are in settings then module should be ottocrat
		...
		AppConnector.request(searchableModulesParams).then(
			function(data){
				...
				//add to cache
				Ottocrat_AdvanceSearch_Js.cache[searchModule] = data;
	...
	initiateSearch : function() {
		...
		var postLoad = function(uiData) {
			...
			thisInstance.advanceFilter = new Ottocrat_SearchAdvanceFilter_Js(jQuery('.filterContainer',uiData));
