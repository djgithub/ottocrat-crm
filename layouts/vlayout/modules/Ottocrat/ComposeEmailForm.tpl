		...
		<div class="row-fluid toEmailField padding10">
			<span class="span8">
				<span class="row-fluid">
					...
					value="{$TO_EMAILS}" data-validation-engine="validate[required, funcCall[Ottocrat_To_Email_Validator_Js.invokeValidation]]"
		...
		<div class="{if empty($CC)}hide {/if} padding10 row-fluid" id="ccContainer">
			<div class="span8">
				<div class="row-fluid">
					...
					<input class="span9"  data-validation-engine="validate[funcCall[Ottocrat_MultiEmails_Validator_Js.invokeValidation]]" type="text" name="cc" value="{if !empty($CC)}{$CC}{/if}"/>
				</div>
			</div>
			<div class="span4"></div>
		</div>
		<div class="row-fluid {if empty($BCC)}hide {/if} padding10" id="bccContainer">
			<span class="span8">
				<span class="row-fluid">
					...
					<input class="span9" data-validation-engine="validate[funcCall[Ottocrat_MultiEmails_Validator_Js.invokeValidation]]" type="text" name="bcc" value="{if !empty($BCC)}{$BCC}{/if}"/>
				</span>
			</span>
