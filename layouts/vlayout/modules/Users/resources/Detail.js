...
Ottocrat_Detail_Js("Users_Detail_Js",{
		...
		if(new_password.val() == confirm_password.val()){
			...
			AppConnector.request(params).then(
				function(data) {
					if(data.success){
						app.hideModalWindow();
						Ottocrat_Helper_Js.showPnotify(app.vtranslate(data.result.message));
					}else{
	...
	deleteUser: function (form){
		...
		AppConnector.request(params).then(
			function(data) {
				if(data.success){
					app.hideModalWindow();
					Ottocrat_Helper_Js.showPnotify(app.vtranslate(data.result.status.message));
	...
	registerEvents : function() {
        this._super();
		var form = this.getForm();
		this.usersEditInstance = Ottocrat_Edit_Js.getInstance();
