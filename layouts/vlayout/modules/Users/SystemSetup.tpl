        ...
        <body>
            ...
            <div class="container-fluid page-container">
                <div class="row-fluid">
                    <div class="span6">
                        <div class="logo">
                            <img src="test/logo/logo2.png" alt="Ottocrat Logo"/>
                        </div>
                    </div>
                    <div class="span6"></div>
                </div>
                <div class="row-fluid main-container">
                    <div class="span12 inner-container">
                        <div class="row-fluid">
                            <div class="span8">
                                <h3 style="display: inline-block;float:left;"> What would you like to use Ottocrat CRM for? </h3> 
									...
									<div class="group-container {if $COUNTER eq 0} span12 selectedContainer js-basePack {else} span6 {/if}">
										...
										<div class="row-fluid">
											<div class="{if $COUNTER eq 0} span2 {else} span3 {/if}">
												<img src="layouts/vlayout/skins/images/{$PACKAGE_INFO.imageName}" alt="Ottocrat Logo"/>
											</div>
