...
<html>
	<head>
		<title>Ottocrat login page</title>
	...
	<body>
		<div class="container-fluid login-container">
			<div class="row-fluid">
				...
				<div class="span9">
					<div class="helpLinks">
						<a href="https://www.ottocrat.com">Ottocrat Website</a> |
						<a href="https://wiki.ottocrat.com/ottocrat6/">Ottocrat Wiki</a> |
						<a href="https://www.ottocrat.com/crm/videos/">Ottocrat videos </a> |
						<a href="https://discussions.ottocrat.com/">Ottocrat Forums</a>
					</div>
				</div>
			</div>
			<div class="row-fluid">
							...
							<div class="row-fluid">
								<div class="span6">
									<div class="carousal-container">
										<div><h2> Get more out of Ottocrat </h2></div>
										<ul class="bxslider">
											<li>
								...
								<div class="span6">
									<div class="login-area">
										<div class="login-box" id="loginDiv">
											<div class="">
												<h3 class="login-header">Login to Ottocrat CRM</h3>
		</div>
			...
			<div class="control-group">
				...
				<div class="controls">
												...
												<img src='//stats.ottocrat.com/stats.php?uid={$APPUNIQUEKEY}&v={$CURRENT_VERSION}&type=U' alt='' title='' border=0 width='1px' height='1px'>
											</form>
											<div class="login-subscript">
												<small> Powered by ottocrat CRM {$CURRENT_VERSION}</small>
											</div>
				</div>
						...
						<div class="span6 pull-left" >
							<div class="footer-content">
								<small>&#169 2004-{date('Y')}&nbsp;
									<a href="https://www.ottocrat.com"> ottocrat.com</a> |
									<a href="https://www.ottocrat.com/LICENSE.txt">Read License</a> |
									<a href="https://www.ottocrat.com/products/crm/privacy_policy.html">Privacy Policy</a> </small>
							</div>
						</div>
						<div class="span6 pull-right" >
							<div class="pull-right footer-icons">
								<small>{vtranslate('LBL_CONNECT_WITH_US', $MODULE)}&nbsp;</small>
								<a href="https://www.facebook.com/ottocrat"><img src="layouts/vlayout/skins/images/facebook.png"></a>
								&nbsp;<a href="https://twitter.com/ottocratcrm"><img src="layouts/vlayout/skins/images/twitter.png"></a>
								&nbsp;<a href="https://www.linkedin.com/company/ottocrat-systems-india-pvt-ltd"><img src="layouts/vlayout/skins/images/linkedin.png"></a>
								&nbsp;<a href="http://www.youtube.com/user/ottocratcrm"><img src="layouts/vlayout/skins/images/youtube.png"></a> 
							</div>
						</div>
					</div>   
				</div>    
