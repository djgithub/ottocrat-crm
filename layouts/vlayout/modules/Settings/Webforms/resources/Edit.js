...
Settings_Ottocrat_Edit_Js('Settings_Webforms_Edit_Js', {}, {
	...
	displaySelectedField : function(selectedField){
		...
		var fieldInstance = Ottocrat_Field_Js.getInstance(selectedFieldInfo,moduleName);
    ...
    registerUsersListMandatoryOnRoundrobinChecked : function() {
        ...
        roundrobinCheckboxElement.change(function(){
            if(jQuery(this).is(':checked')){
                ...
                userListSelectElement.attr('data-validation-engine','validate[required,funcCall[Ottocrat_Base_Validator_Js.invokeValidation]]');
            }
            else{
                userListLabelElement.find('span.redColor').addClass('hide');
                userListSelectElement.attr('data-validation-engine','');
