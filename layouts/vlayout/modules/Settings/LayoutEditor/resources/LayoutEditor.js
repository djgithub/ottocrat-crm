...
jQuery.Class('Settings_LayoutEditor_Js', {
	...
	updateBlockSequence : function() {
		...
		AppConnector.request(params).then(
			function(data) {
				...
				Settings_Ottocrat_Index_Js.showMessage(params);
			},
			function(error) {
				progressIndicatorElement.progressIndicator({'mode' : 'hide'});
			}
	...
	setFieldDetails : function(result, form) {
		...
		var fieldModel = Ottocrat_Field_Js.getInstance(result);
		...
		defaultValueUi.find('[data-validation-engine]').attr('data-validation-engine','validate[required,funcCall[Ottocrat_Base_Validator_Js.invokeValidation]]');
...
Ottocrat_WholeNumberGreaterThanZero_Validator_Js("Ottocrat_FloatingDigits_Validator_Js",{
	...
	invokeValidation: function(field, rules, i, options){
		var rangeInstance = new Ottocrat_FloatingDigits_Validator_Js();
...
Ottocrat_WholeNumberGreaterThanZero_Validator_Js("Ottocrat_DecimalMaxLength_Validator_Js",{
	 ...
	 */
	invokeValidation: function(field, rules, i, options){
		var rangeInstance = new Ottocrat_DecimalMaxLength_Validator_Js();
		rangeInstance.setElement(field);
		var response = rangeInstance.validate();
		if(response != true){
			return rangeInstance.getError();
...
Ottocrat_WholeNumberGreaterThanZero_Validator_Js("Ottocrat_MaxLength_Validator_Js",{
...
Ottocrat_Base_Validator_Js("Ottocrat_PicklistFieldValues_Validator_Js",{
	 ...
	 */
	invokeValidation: function(field, rules, i, options){
		var instance = new Ottocrat_PicklistFieldValues_Validator_Js();
		instance.setElement(field);
		var response = instance.validate();
		if(response != true){
			return instance.getError();
