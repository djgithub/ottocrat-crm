...
Settings_Ottocrat_Index_Js("Settings_PBXManager_Index_Js", {},{
    ...
    */
	...
	registerEditViewEvents : function() {
		...
		var form = jQuery('#MyModal');
                ...
                //To Auto-Generate Ottocrat Secret Key
                var url = 'index.php?module=PBXManager&parent=Settings&action=Gateway&mode=getSecretKey';
                 AppConnector.request(url).then(
                    function(data) {
                        jQuery("input[name='ottocratsecretkey']").attr("value",data.result);
                    }
                 );
		//END
...
jQuery(document).ready(function(e){
	var instance = new Settings_Ottocrat_Index_Js();
