		...
		<div class="modal-body tabbable">
			...
			<div class="control-group">
				...
				<div class="controls row-fluid">
					...
					{/if}
					<input type="text" class="span2" value="{$FIELD_VALUE}" data-validation-engine="validate[required,funcCall[Ottocrat_WholeNumberGreaterThanZero_Validator_Js.invokeValidation]]" id="frequencyValue"/>&nbsp;
