                            ...
                            <div id="scheduleBox" class='well contentsBackground {if $WORKFLOW_MODEL_OBJ->executionCondition neq 6} hide {/if}'>
                                ...
                                <div class='row-fluid {if $WORKFLOW_MODEL_OBJ->schtypeid neq 3} hide {/if}' id='scheduledWeekDay' style='padding:5px 0px;'>
                                    ...
                                    <div class='span4'>
                                        ...
                                        <select style='width:230px;' multiple class='chosen' data-validation-engine="validate[required,funcCall[Ottocrat_Base_Validator_Js.invokeValidation]]" name='schdayofweek' id='schdayofweek'>
                                ...
                                <div class='row-fluid {if $WORKFLOW_MODEL_OBJ->schtypeid neq 5} hide {/if}' id='scheduleMonthByDates' style="padding:5px 0px;">
                                    ...
                                    <div class='span4'>
                                        ...
                                        <select style='width:230px;' multiple class="chosen-select" data-validation-engine="validate[required,funcCall[Ottocrat_Base_Validator_Js.invokeValidation]]" name='schdayofmonth' id='schdayofmonth' >
                                ...
                                <div class='row-fluid {if $WORKFLOW_MODEL_OBJ->schtypeid neq 4} hide {/if}' id='scheduleByDate' style="padding:5px 0px;">
                                    ...
                                    <div class='span6'>
                                        <div class='input-append row-fluid'>
                                            ...
                                            <input style='width: 185px;' type="text" class="dateField" name="schdate" value="{$specificDate1}" data-date-format="{$CURRENT_USER->date_format}" data-validation-engine="validate[ required,funcCall[Ottocrat_Base_Validator_Js.invokeValidation]]"/>
                            ...
                            <div class='row-fluid {if $WORKFLOW_MODEL_OBJ->schtypeid < 2} hide {/if}' id='scheduledTime' style='padding:5px 0px 10px 0px;'>
                                ...
                                <div class='span4' id='schtime'>
                                    <div class="input-append time">
                                        <input type='text' class='timepicker-default input-small' data-format='24' name='schtime' value="{$WORKFLOW_MODEL_OBJ->schtime}" data-validation-engine="validate[required,funcCall[Ottocrat_Base_Validator_Js.invokeValidation]]"/>
