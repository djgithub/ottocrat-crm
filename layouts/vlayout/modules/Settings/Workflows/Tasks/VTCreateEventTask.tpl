...
{strip}
	<div class="row-fluid">
		...
		<div class="row-fluid padding-bottom1per">
			...
			{else}
				{assign var=DATE_TIME_VALUE value=Ottocrat_Datetime_UIType::getDateTimeValue('now')}
		...
		<div class="row-fluid padding-bottom1per">
			...
			<span class="span2 row-fluid">
				<input class="span6" type="text" value="{$TASK_OBJECT->startDays}" name="startDays"
					   data-validation-engine="validate[funcCall[Ottocrat_WholeNumber_Validator_Js.invokeValidation]]">&nbsp;
							...
							<div class="span">
								<div class="input-append date">
									<input type="text" id="calendar_repeat_limit_date" class="dateField input-small" name="calendar_repeat_limit_date" data-date-format="{$dateFormat}"
										   value="{$REPEAT_DATE}" data-validation-engine='validate[funcCall[Ottocrat_Date_Validator_Js.invokeValidation]]'/>
