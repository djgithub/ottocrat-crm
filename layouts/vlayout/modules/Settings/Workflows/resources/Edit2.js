...
Settings_Workflows_Edit_Js("Settings_Workflows_Edit2_Js",{},{
	...
	submit : function(){
		...
		AppConnector.request(formData).then(
			function(data) {
				form.hide();
				if(data.result) {
					Settings_Ottocrat_Index_Js.showMessage({text : app.vtranslate('JS_WORKFLOW_SAVED_SUCCESSFULLY')});
	...
	registerEvents : function(){
		...
		this.advanceFilterInstance = Ottocrat_AdvanceFilter_Js.getInstance(jQuery('.filterContainer',container));
		this.getPopUp();
