 ...
 * All Rights Reserved.
 *************************************************************************************/
Settings_Ottocrat_Edit_Js("Settings_Workflows_Edit_Js",{
	...
	registerPopUpSaveEvent : function(data,fieldUiHolder) {
		jQuery('[name="saveButton"]',data).on('click',function(e){
            ...
            if(valueType != 'rawtext'){
                ...
                fieldValueElement.removeClass('validate[funcCall[Ottocrat_Base_Validator_Js.invokeValidation]]');
            }else{
                fieldValueElement.addClass('validate[funcCall[Ottocrat_Base_Validator_Js.invokeValidation]]');
                fieldValueElement.attr('data-validation-engine','validate[funcCall[Ottocrat_Base_Validator_Js.invokeValidation]]');
            }
