 ...
 * All Rights Reserved.
 *************************************************************************************/
Ottocrat_AdvanceFilter_Js('Workflows_AdvanceFilter_Js',{},{
...
Ottocrat_Field_Js('Workflows_Field_Js',{},{
...
Ottocrat_Date_Field_Js('Workflows_Date_Field_Js',{},{
	...
	getUi : function() {
		...
		if(comparatorSelectedOptionVal.length > 0) {
			if(comparatorSelectedOptionVal == 'between' || comparatorSelectedOptionVal == 'custom'){
				...
				var html = '<input name="'+ this.getName() +'" type="text" value="'+this.getValue()+'" data-validation-engine="validate[funcCall[Ottocrat_Base_Validator_Js.invokeValidation]]" data-validator="[{"name":"PositiveNumber"}]">\n\
...
Ottocrat_Date_Field_Js('Workflows_Datetime_Field_Js',{},{
	/**
	 * Function to get the user date format
	 */
	getDateFormat : function(){
...
Ottocrat_Currency_Field_Js('Workflows_Currency_Field_Js',{},{
...
Ottocrat_Time_Field_Js('Workflows_Time_Field_Js',{},{
...
Ottocrat_Field_Js('Ottocrat_Percentage_Field_Js',{},{
...
Ottocrat_Field_Js('Ottocrat_Text_Field_Js',{},{
...
Ottocrat_Field_Js('Ottocrat_Boolean_Field_Js',{},{
...
Ottocrat_Owner_Field_Js('Workflows_Owner_Field_Js',{},{
...
Ottocrat_Picklist_Field_Js('Workflows_Picklist_Field_Js',{},{
