            ...
            <div class="span12">
				...
				{assign var=WIDTHTYPE value=$CURRENT_USER_MODEL->get('rowheight')}
                    ...
                    <tr>
                        ...
                        <td class="fieldValue {$WIDTHTYPE}" style="border-left: none">
                            <input type="text" value="{$DEFAULT_MODULE_DATA['prefix']}" data-old-prefix="{$DEFAULT_MODULE_DATA['prefix']}" name="prefix" data-validation-engine="validate[funcCall[Ottocrat_AlphaNumeric_Validator_Js.invokeValidation]]"/>
                        </td>
                    </tr>
                    <tr>
                        <td class="{$WIDTHTYPE}">
                        ...
                        <td class="fieldValue {$WIDTHTYPE}" style="border-left: none">
                            <input type="text" value="{$DEFAULT_MODULE_DATA['sequenceNumber']}"
                                   ...
                                   data-validation-engine="validate[required,funcCall[Ottocrat_WholeNumber_Validator_Js.invokeValidation]]"/>
                        </td>
                    </tr>
                </tbody>
                </table>
