...
jQuery.Class("Settings_Ottocrat_ConfigEditor_Js",{},{
...
jQuery(document).ready(function(e){
	var tacInstance = new Settings_Ottocrat_ConfigEditor_Js();
	tacInstance.registerEvents();
})

Ottocrat_WholeNumberGreaterThanZero_Validator_Js("Ottocrat_NumberRange5_Validator_Js",{
	...
	invokeValidation: function(field, rules, i, options){
		var rangeInstance = new Ottocrat_NumberRange5_Validator_Js();
...
Ottocrat_WholeNumberGreaterThanZero_Validator_Js("Ottocrat_NumberRange100_Validator_Js",{
	 ...
	 */
	invokeValidation: function(field, rules, i, options){
		var rangeInstance = new Ottocrat_NumberRange100_Validator_Js();
		rangeInstance.setElement(field);
		var response = rangeInstance.validate();
		if(response != true){
			return rangeInstance.getError();
