				...
				<div class="row-fluid">
					...
					<div class="control-group">
						...
						<div class="controls input-append">
							<input class="span2" type="text" name="percentage" class="input-medium" placeholder="{vtranslate('LBL_ENTER_TAX_VALUE', $QUALIFIED_MODULE)}" value="{$TAX_RECORD_MODEL->getTax()}" data-validation-engine='validate[required, funcCall[Ottocrat_Percentage_Validator_Js.invokeValidation]]' />
