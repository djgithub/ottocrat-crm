...
{strip}
	...
	<form class="form-horizontal" id="ruleSave" method="post" name="step3">
		...
		<div class="control-group">
			...
			<input type="text" name="{$FIELD_MODEL->getName()}" value="{$RECORD_MODEL->get($FIELD_NAME)}" data-validation-engine="validate[funcCall[Ottocrat_Email_Validator_Js.invokeValidation]]"/>
		    {else}
