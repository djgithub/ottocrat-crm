                                            ...
                                            {foreach $CUSTOMER_REVIEWS as $key=>$CUSTOMER_REVIEW}
                                                <div class="row-fluid" style="margin: 8px 0 15px;">
                                                    <div class="span3">
                                                        ...
                                                        <div class="muted">{Ottocrat_Util_Helper::formatDateTimeIntoDayString($REVIEW_CREATED_TIME)|substr:4}</div>
                                                    </div>
                    ...
                    <form class="form-horizontal customerReviewForm">
                        ...
                        <div class="modal-body">
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <textarea name="customerReview" data-validation-engine="validate[required, funcCall[Ottocrat_Base_Validator_Js.invokeValidation]]"></textarea>
                                </div>
                            </div>
                            <div class="control-group">
                                <span class="control-label">
