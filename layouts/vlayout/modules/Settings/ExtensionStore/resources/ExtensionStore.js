                        ...
                        AppConnector.request(formData).then(
                                function(data) {
                                    if (data.success) {
                                        ...
                                        app.hideModalWindow();
                                        Settings_Ottocrat_Index_Js.showMessage({text:app.vtranslate('JS_CARD_DETAILS_UPDATED')});
                                    } else {
                                        progressIndicatorElement.progressIndicator({'mode': 'hide'});
                                        app.hideModalWindow();
        ...
        jQuery(container).on('click', '.oneclickInstallFree, .oneclickInstallPaid', function(e) {
	     ...
	     var message = app.vtranslate('JS_LBL_ARE_YOU_SURE_YOU_WANT_TO_INSTALL_THIS_EXTENSION');
            ...
            if(element.hasClass('loginRequired')){
                ...
                Settings_Ottocrat_Index_Js.showMessage(loginErrorParam);
                return false;
            }
            var params = {
                'module': app.getModuleName(),
    ...
    registerEventsForExtensionStoreDetail: function(container) {
	    ...
	    var message = app.vtranslate('JS_LBL_ARE_YOU_SURE_YOU_WANT_TO_INSTALL_THIS_EXTENSION');
            ...
            if(element.hasClass('setUpCard')){
                ...
                Settings_Ottocrat_Index_Js.showMessage(paidErrorParam);
                return false;
            }
