...
{strip}
    <div class="container-fluid" id="importModules">
        <div class="widget_header row-fluid">
            <span class="span6">
                <h3>{vtranslate('LBL_OTTOCRAT_EXTENSION_STORE', $QUALIFIED_MODULE)}</h3>
            </span>
        </div><hr>
            ...
            <form class="form-horizontal signUpForm">
                ...
                <div class="modal-body">
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" name="emailAddress" data-validation-engine="validate[required, funcCall[Ottocrat_Base_Validator_Js.invokeValidation]]" />
                        </div>
                    </div>
                    <div class="control-group">
                        <span class="control-label">
                        ...
                        <div class="controls">
                            <input type="text" name="firstName" data-validation-engine="validate[required, funcCall[Ottocrat_Base_Validator_Js.invokeValidation]]" />
                        </div>
                    </div>
                    <div class="control-group">
                        <span class="control-label">
                        ...
                        <div class="controls">
                            <input type="text" name="lastName" data-validation-engine="validate[required, funcCall[Ottocrat_Base_Validator_Js.invokeValidation]]" />
                        </div>
                    </div>
                    <div class="control-group">
                        <span class="control-label">
                        ...
                        <div class="controls">
                            <input type="text" name="companyName" data-validation-engine="validate[required, funcCall[Ottocrat_Base_Validator_Js.invokeValidation]]" />
                        </div>
                    </div>
                    <div class="control-group">
                        <span class="control-label">
                        ...
                        <div class="controls">
                            <input type="password" name="password" data-validation-engine="validate[required, funcCall[Ottocrat_Base_Validator_Js.invokeValidation]]" />
                        </div>
                    </div>
                    <div class="control-group">
                        <span class="control-label">
                        ...
                        <div class="controls">
                            <input type="password" name="confirmPassword" data-validation-engine="validate[required, funcCall[Ottocrat_Base_Validator_Js.invokeValidation]]" />
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
                ...
                <div class="modal-body">
                    <div class="control-group">
                        ...
                        <div class="controls">
                            ...
                            {else}
                                <input type="text" name="emailAddress" data-validation-engine="validate[required, custom[email],funcCall[Ottocrat_Base_Validator_Js.invokeValidation]]" />
                            {/if}
                        </div>
                    </div>
                    <div class="control-group">
        ...
        {if $LOADER_REQUIRED}
            <div class="modal extensionLoader hide">
                ...
                <div class="modal-body">
                    <div class="row-fluid">
                        <p>{vtranslate('LBL_TO_CONTINUE_USING_EXTENSION_STORE', $QUALIFIED_MODULE)}<a href="https://marketplace.ottocrat.com/loaderfiles/{$LOADER_INFO['loader_file']}">{vtranslate('LBL_DOWNLOAD', $QUALIFIED_MODULE)}</a>{vtranslate('LBL_COMPATIABLE_EXTENSION', $QUALIFIED_MODULE)}</p>
                    </div>
                    <div class="row-fluid">
                        <p>{vtranslate('LBL_MORE_DETAILS_ON_INSTALLATION', $QUALIFIED_MODULE)}<a onclick=window.open("http://community.ottocrat.com/help/ottocratcrm/php/extension-loader.html")>{vtranslate('LBL_READ_HERE', $QUALIFIED_MODULE)}</a></p>
                    </div>
                </div>
                <div class="modal-footer">
                    <div class="row-fluid">
