 ...
 */
class Inventory_Record_Model extends Ottocrat_Record_Model {
	 ...
	 * @return <Model> returns Ottocrat_Record_Model
	 */
	 ...
	 * @param Ottocrat_Record_Model $parentRecordModel
	 * @return Inventory_Record_Model
	 */
	public function setParentRecordData(Ottocrat_Record_Model $parentRecordModel) {
		...
		foreach ($fieldMappingList as $fieldMapping) {
            ...
            $fieldModel = Ottocrat_Field_Model::getInstance($parentField,  Ottocrat_Module_Model::getInstance($moduleName));
	...
	public function getPDF() {
		...
		$controllerClassName = "Ottocrat_". $moduleName ."PDFController";
    ...
    public function getPDFFileName() {
		...
		if ($moduleName == 'Quotes') {
			...
			$controllerClassName = "Ottocrat_QuotePDFController";
		} else {
