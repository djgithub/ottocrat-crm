...
class Inventory_DetailView_Model extends Ottocrat_DetailView_Model {
	...
	public function getDetailViewLinks($linkParams) {
		...
		if(Users_Privileges_Model::isPermitted($moduleName, 'DetailView', $recordModel->getId())) {
			$detailViewLinks = array( 
                        ...
                        $linkModelList['DETAILVIEW'][] = Ottocrat_Link_Model::getInstanceFromValues($detailViewLinks); 
                        ...
                        $linkModelList['DETAILVIEW'][] = Ottocrat_Link_Model::getInstanceFromValues($sendEmailLink); 
		}
