...
class Potentials_GroupedBySalesStage_Dashboard extends Ottocrat_IndexAjax_View {
	...
	public function process(Ottocrat_Request $request) {
		...
		if(!empty($dates)) {
			$dates['start'] = Ottocrat_Date_UIType::getDBInsertedValue($dates['start']);
			$dates['end'] = Ottocrat_Date_UIType::getDBInsertedValue($dates['end']);
		}
