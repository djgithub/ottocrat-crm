...
/**
 * Ottocrat MenuStructure Model
 */
class Ottocrat_MenuStructure_Model extends Ottocrat_Base_Model {
	 ...
	 * @return <array> - Associate array of Parent name mapped to Ottocrat_Menu_Model instances
	 */
	...
	/**
	 * Function to get an instance of the Ottocrat MenuStructure Model from list of menu models
	 * @param <array> $menuModelList - array of Ottocrat_Menu_Model instances
	 * @return Ottocrat_MenuStructure_Model instance
	 */
	public static function getInstanceFromMenuList($menuModelList, $selectedMenu='') {
		...
		foreach ($menuListArray[self::MORE_MENU_INDEX] as $parent => &$values) {
			uksort($values, array('Ottocrat_MenuStructure_Model', 'sortMenuItemsByProcess'));
		}
		//uksort($menuListArray[self::TOP_MENU_INDEX], array('Ottocrat_MenuStructure_Model', 'sortMenuItemsByProcess'));
