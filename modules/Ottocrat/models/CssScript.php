 ...
 */
class Ottocrat_CssScript_Model extends Ottocrat_Base_Model {
	...
	/**
	 * Function to get the instance of CSS Script model from a given Ottocrat_Link object
	 * @param Ottocrat_Link $linkObj
	 * @return Ottocrat_CssScript_Model instance
	 */
