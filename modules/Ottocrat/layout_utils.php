...
if ($show_help==true) {
     ...
     $the_form .= "<td class='bodySmall' align='right'>[ <A href='http://www.ottocrat.com/products/crm/document.html' target='_blank'>".$app_strings['LNK_HELP']."</A> ]</td>\n";
}
...
//	$the_title .= "<td class='bodySmall' nowrap align='right'> <A href='http://www.ottocrat.com/products/crm/document.html' target='_blank'><img align=absmiddle hspace=3 border=0 src='themes/images/help_icon.gif'>".$app_strings['LNK_HELP']."</A></td>\n";
}
else {
