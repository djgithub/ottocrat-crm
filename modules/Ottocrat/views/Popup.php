...
class Ottocrat_Popup_View extends Ottocrat_Footer_View {
	 ...
	 * @return <String>
	 */
	function getModule(Ottocrat_request $request) {
		$moduleName = $request->getModule();
		return $moduleName;
	}
	...
	function getHeaderScripts(Ottocrat_Request $request) {
		...
		$jsFileNames = array(
			...
			'modules.Ottocrat.resources.BaseList',
	...
	public function initializeListViewContents(Ottocrat_Request $request, Ottocrat_Viewer $viewer) {
        ...
        $isRecordExists = Ottocrat_Util_Helper::checkRecordExistance($relatedParentId);
		...
		if(!empty($relatedParentModule) && !empty($relatedParentId)) {
			$parentRecordModel = Ottocrat_Record_Model::getInstanceById($relatedParentId, $relatedParentModule);
			$listViewModel = Ottocrat_RelationListView_Model::getInstance($parentRecordModel, $moduleName, $label);
		}else{
