 ...
 */
class Calendar_ListView_Model extends Ottocrat_ListView_Model {
	...
	public function getListViewMassActions($linkParams) {
		...
		if($currentUserModel->hasModuleActionPermission($moduleModel->getId(), 'EditView')) {
			$massActionLinks[] = array(
				...
				'linkurl' => 'javascript:Calendar_List_Js.triggerMassEdit("'.Ottocrat_Request:: encryptLink("index.php?module='.$moduleModel->get('name').'&view=MassActionAjax&mode=showMassEditForm").'");',
				'linkicon' => ''
			);
		}
	...
	public function getListViewHeaders() {
		...
		foreach($headerFields as $fieldName => $webserviceField) {
            ...
            $fieldInstance = Ottocrat_Field_Model::getInstance($fieldName,$module);
            if(!$fieldInstance) {
                if($moduleName == 'Calendar') {
                    $eventmodule = Ottocrat_Module_Model::getInstance('Events');
                    $fieldInstance = Ottocrat_Field_Model::getInstance($fieldName,$eventmodule);
                }
            }
