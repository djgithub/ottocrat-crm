 ...
 */
class Calendar_Field_Model extends Ottocrat_Field_Model {
	...
	*/
    ...
    public static function getReccurencePicklistValues() {
		$currentUser = Users_Record_Model::getCurrentUserModel();
		$fieldModel = Ottocrat_Field_Model::getInstance('recurringtype', Ottocrat_Module_Model::getInstance('Events'));
		if($fieldModel->isRoleBased() && !$currentUser->isAdminUser()) {
			$userModel = Users_Record_Model::getCurrentUserModel();
			$picklistValues = Ottocrat_Util_Helper::getRoleBasedPicklistValues('recurringtype', $userModel->get('roleid'));
		}else{
			$picklistValues = Ottocrat_Util_Helper::getPickListValues('recurringtype');
		}
