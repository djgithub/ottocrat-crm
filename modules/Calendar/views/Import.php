...
class Calendar_Import_View extends Ottocrat_Import_View {
	 ...
	 */
	public function import(Ottocrat_Request $request) {
	 ...
	 * @param Ottocrat_Request $request
	 */
	public function importResult(Ottocrat_Request $request) {
		...
		if (Import_Utils_Helper::validateFileUpload($request)) {
			...
			$calendarModel = Ottocrat_Module_Model::getInstance($moduleName);
	 ...
	 * @param Ottocrat_Request $request
	 */
	public function undoImport(Ottocrat_Request $request) {
		$currentUserModel = Users_Record_Model::getCurrentUserModel();
		$moduleName = $request->getModule();
