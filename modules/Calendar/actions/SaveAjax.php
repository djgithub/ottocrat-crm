...
class Calendar_SaveAjax_Action extends Ottocrat_SaveAjax_Action {
	...
	public function process(Ottocrat_Request $request) {
		...
		foreach ($fieldModelList as $fieldName => $fieldModel) {
			$fieldValue =  Ottocrat_Util_Helper::toSafeHTML($recordModel->get($fieldName));
	...
	public function getRecordModelFromRequest(Ottocrat_Request $request) {
		...
		if(!empty($endDate)) {
			...
			if ($endTime) {
				$endTime = Ottocrat_Time_UIType::getTimeValueWithSeconds($endTime);
