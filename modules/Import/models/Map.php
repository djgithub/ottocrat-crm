...
class Import_Map_Model extends Ottocrat_Base_Model {

	static $tableName = 'ottocrat_import_maps';
	var $map;
	var $user;
	...
	public static function markAsDeleted($mapId) {
		...
		$db->pquery('UPDATE ottocrat_import_maps SET deleted=1 WHERE id=?', array($mapId));
	}
