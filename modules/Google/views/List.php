...
class Google_List_View extends Ottocrat_PopupAjax_View {
    ...
    function renderWidgetUI(Ottocrat_Request $request) {
    ...
    function renderSyncUI(Ottocrat_Request $request) {
        $sourceModule = $request->get('sourcemodule');
        $viewer = $this->getViewer($request);
        $viewer->assign('SCRIPTS',$this->getHeaderScripts($request));
        $oauth2 = new Google_Oauth2_Connector($sourceModule); 
    ...
    public function Contacts() {
        ...
        $syncRecords['ottocrat']['more'] = $controller->targetConnector->moreRecordsExits();
    ...
    public function getSyncRecordsCount($syncRecords) {
        $countRecords = array('ottocrat' => array('update' => 0, 'create' => 0, 'delete' => 0), 'google' => array('update' => 0, 'create' => 0, 'delete' => 0));
