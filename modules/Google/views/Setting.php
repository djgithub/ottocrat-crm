...
class Google_Setting_View extends Ottocrat_PopupAjax_View {
    ...
    public function emitContactsSyncSettingUI(Ottocrat_Request $request) {
        ...
        $contactsModuleModel = Ottocrat_Module_Model::getInstance($request->get('sourcemodule'));
        ...
        $viewer->assign('OTTOCRAT_EMAIL_FIELDS',$emailFields);
        $viewer->assign('OTTOCRAT_PHONE_FIELDS',$phoneFields);
        $viewer->assign('OTTOCRAT_URL_FIELDS',$urlFields);
        $viewer->assign('OTTOCRAT_OTHER_FIELDS',$otherFields);
