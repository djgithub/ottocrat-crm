...
class Products_RelationAjax_Action extends Ottocrat_RelationAjax_Action {
	...
	function addRelation($request) {
		...
		foreach($relatedRecordIdList as $relatedRecordId) {
			...
			if($relatedModule == 'PriceBooks'){
				$recordModel = Ottocrat_Record_Model::getInstanceById($relatedRecordId);
				if ($sourceRecordId && ($sourceModule === 'Products' || $sourceModule === 'Services')) {
					$parentRecordModel = Ottocrat_Record_Model::getInstanceById($sourceRecordId, $sourceModule);
