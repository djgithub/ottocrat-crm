...
class Users_Save_Action extends Ottocrat_Save_Action {
	...
	public function process(Ottocrat_Request $request) {
		...
		if ($request->get('relationOperation')) {
			$parentRecordModel = Ottocrat_Record_Model::getInstanceById($request->get('sourceRecord'), $request->get('sourceModule'));
