...
class Leads_SaveConvertLead_View extends Ottocrat_View_Controller {
	...
	public function process(Ottocrat_Request $request) {
		...
		$recordModel = Ottocrat_Record_Model::getInstanceById($recordId, $request->getModule());
			...
			if(vtlib_isModuleActive($module)&& in_array($module, $modules)) {
				...
				foreach ($convertLeadFields[$module] as $fieldModel) {
					...
					if ($fieldModel->getFieldDataType() === 'currency') {
						$fieldValue = Ottocrat_Currency_UIType::convertToDBFormat($fieldValue);
