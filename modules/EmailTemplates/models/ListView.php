...
class EmailTemplates_ListView_Model extends Ottocrat_ListView_Model {
	...
	function getQuery() {
		$listQuery = 'SELECT templateid, templatename, foldername, subject FROM ottocrat_emailtemplates';
		return $listQuery;
	}
