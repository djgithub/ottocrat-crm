...
class EmailTemplates_Record_Model extends Ottocrat_Record_Model {
	...
	public function getDetailViewUrl() {
		...
		return Ottocrat_Request:: encryptLink('index.php?module='.$this->getModuleName().'&view='.$module->getDetailViewName().'&record='.$this->getId());
	}
	...
	public static function getInstanceById($templateId, $module=null) {
		...
		$sql = 'SELECT * FROM ottocrat_emailtemplates WHERE templateid = ?';
