...
class PriceBooks_ListView_Model extends Ottocrat_ListView_Model {
	...
	public function getListViewEntries($pagingModel) {
        ...
        if(!empty($orderBy)){
            ...
            if($orderByFieldModel && ($orderByFieldModel->isReferenceField()
					|| $orderByFieldModel->getFieldDataType() == Ottocrat_Field_Model::CURRENCY_LIST)){
		...
		if(!empty($orderBy)) {
            ...
            } else if($orderByFieldModel && $orderByFieldModel->getFieldDataType() == Ottocrat_Field_Model::CURRENCY_LIST) {
