...
class SMSNotifierBase extends CRMEntity {
	...
	var $table_name = 'ottocrat_smsnotifier';
	 ...
	 */
	var $customFieldTable = Array('ottocrat_smsnotifiercf', 'smsnotifierid');

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	var $tab_name = Array('ottocrat_crmentity', 'ottocrat_smsnotifier', 'ottocrat_smsnotifiercf');
	...
	var $tab_name_index = Array(
		...
		'ottocrat_smsnotifier' => 'smsnotifierid',
		'ottocrat_smsnotifiercf'=>'smsnotifierid');
	...
	function vtlib_handler($modulename, $event_type) {
        ...
        $SMSNotifierModule  = Ottocrat_Module::getInstance('SMSNotifier');
        Ottocrat_Access::setDefaultSharing($SMSNotifierModule);
		...
		if($unregisterLinks) {
			...
			$smsnotifierModuleInstance = Ottocrat_Module::getInstance('SMSNotifier');
			$smsnotifierModuleInstance->deleteLink("HEADERSCRIPT", "SMSNotifierCommonJS", "modules/SMSNotifier/SMSNotifierCommon.js");

			$leadsModuleInstance = Ottocrat_Module::getInstance('Leads');
