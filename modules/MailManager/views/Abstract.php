...
abstract class MailManager_Abstract_View extends Ottocrat_Index_View {
	 ...
	 */
	public function getViewer(Ottocrat_Request $request) {
	 ...
	 * @return type
	 */
	public function getOperationArg(Ottocrat_Request $request) {
