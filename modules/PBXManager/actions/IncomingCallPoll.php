...
class PBXManager_IncomingCallPoll_Action extends Ottocrat_Action_Controller{
    ...
    public function checkModuleViewPermission(Ottocrat_Request $request){
    ...
    public function searchIncomingCalls(Ottocrat_Request $request){
   ...
   public function createRecord(Ottocrat_Request $request){
            $user = Users_Record_Model::getCurrentUserModel();
            ...
            foreach($mandatoryFieldModels as $mandatoryField){
                ...
                if(!empty($element[$fieldName])){
                    ...
                    if(empty($fieldValue)) {
                        $fieldValue = Ottocrat_Util_Helper::getDefaultMandatoryValue($fieldType);
                    }
    ...
    function checkPermissionForPolling(Ottocrat_Request $request) {
        Users_Privileges_Model::getCurrentUserPrivilegesModel();
