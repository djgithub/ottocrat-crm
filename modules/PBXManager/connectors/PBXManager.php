...
class PBXManager_PBXManager_Connector {
    ...
    private static $SETTINGS_REQUIRED_PARAMETERS = array('webappurl' => 'text','outboundcontext' => 'text', 'outboundtrunk' => 'text' , 'ottocratsecretkey' => 'text');
    ...
    public function getOttocratSecretKey() {
        return $this->ottocratsecretkey;
    }
    ...
    public function setServerParameters($serverModel) {
        ...
        $this->ottocratsecretkey = $serverModel->get('ottocratsecretkey');
    }
     ...
     * @param <Ottocrat_Request> $details
     */
