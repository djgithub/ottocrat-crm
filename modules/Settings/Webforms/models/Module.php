...
class Settings_Webforms_Module_Model extends Settings_Ottocrat_Module_Model {

	var $baseTable = 'ottocrat_webforms';
	var $baseIndex = 'id';
	...
	public function getCreateRecordUrl() {
		return Ottocrat_Request:: encryptLink("index.php?module=".$this->getName()."&parent=".$this->getParentName()."&view=Edit");
	}
	...
	public function deleteRecord($recordModel) {
		...
		$db->pquery("DELETE from ottocrat_webforms_field WHERE webformid = ?", array($recordId));
		$db->pquery("DELETE from ottocrat_webforms WHERE id = ?", array($recordId));
		return true;
	}
}
