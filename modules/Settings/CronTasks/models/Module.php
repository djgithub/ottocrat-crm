...
class Settings_CronTasks_Module_Model extends Settings_Ottocrat_Module_Model {

	var $baseTable = 'ottocrat_cron_task';
	var $baseIndex = 'id';
	...
	public function updateSequence($sequencesList) {
		...
		$updateQuery = "UPDATE ottocrat_cron_task SET sequence = CASE";
