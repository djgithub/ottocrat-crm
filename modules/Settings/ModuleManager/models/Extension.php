...
vimport('~~/vtlib/Ottocrat/Net/Client.php');
vimport('~~/vtlib/Ottocrat/Package.php');

class Settings_ModuleManager_Extension_Model extends Ottocrat_Base_Model {
	...
	public static function download($extensionId, $targetFileName) {
		...
		if ($downloadURL) {
			$clientModel = new Ottocrat_Net_Client($downloadURL);
