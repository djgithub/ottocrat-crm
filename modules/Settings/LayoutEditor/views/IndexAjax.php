...
class Settings_LayoutEditor_IndexAjax_View extends Settings_Ottocrat_IndexAjax_View {
	
	function __construct() {
		$this->exposeMethod('getFieldUI');
	}
    
    public function addBlock(Ottocrat_Request $request) {
    ...
    public function getFieldUI (Ottocrat_Request $request) {
