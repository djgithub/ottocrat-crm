...
class Settings_LayoutEditor_Index_View extends Settings_Ottocrat_Index_View {
	...
	public function showFieldLayout(Ottocrat_Request $request) {
	...
	public function showRelatedListLayout(Ottocrat_Request $request) {
		$sourceModule = $request->get('sourceModule');
		$supportedModulesList = Settings_LayoutEditor_Module_Model::getSupportedModules();
