...
class Settings_Workflows_Record_Model extends Settings_Ottocrat_Record_Model {
...
//			return Ottocrat_Language_Handler::getTranslatedString($executionConditionAsLabel, 'Settings:Workflows');
//		}
//		if($key == 'module_name') {
//			$moduleName = parent::get($key);
//			return Ottocrat_Language_Handler::getTranslatedString($moduleName, $moduleName);
//		}
	...
	public function getRecordLinks() {
		...
		$recordLinks = array(
			...
			array(
				...
				'linkurl' => 'javascript:Ottocrat_List_Js.deleteRecord('.$this->getId().');',
				'linkicon' => 'icon-trash'
			)
		);
	...
	public function getDependentModules() {
		...
		$result = $db->pquery("SELECT fieldname, tabid, typeofdata, ottocrat_ws_referencetype.type as reference_module FROM ottocrat_field
								INNER JOIN ottocrat_ws_fieldtype ON ottocrat_field.uitype = ottocrat_ws_fieldtype.uitype
								INNER JOIN ottocrat_ws_referencetype ON ottocrat_ws_fieldtype.fieldtypeid = ottocrat_ws_referencetype.fieldtypeid
							UNION
							SELECT fieldname, tabid, typeofdata, relmodule as reference_module FROM ottocrat_field
								INNER JOIN ottocrat_fieldmodulerel ON ottocrat_field.fieldid = ottocrat_fieldmodulerel.fieldid", array());
