...
class Settings_Workflows_TaskType_Model extends Ottocrat_Base_Model {
	...
	public static function getInstanceFromClassName($taskClass) {
		...
		$result = $db->pquery("SELECT * FROM com_ottocrat_workflow_tasktypes where classname=?",array($taskClass));
	...
	public function getTaskBaseModule() {
		...
		switch($taskTypeName) {
			case 'VTCreateTodoTask' : return Ottocrat_Module_Model::getInstance('Calendar');
			case 'VTCreateEventTask' : return Ottocrat_Module_Model::getInstance('Events');
		}
	}
