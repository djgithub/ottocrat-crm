...
class Settings_Workflows_RecordStructure_Model extends Ottocrat_RecordStructure_Model {
	...
	public static function getInstanceForWorkFlowModule($workFlowModel, $mode) {
		$className = Ottocrat_Loader::getComponentClassName('Model', $mode.'RecordStructure', 'Settings:Workflows');
