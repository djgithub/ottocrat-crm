...
class Settings_Picklist_Index_View extends Settings_Ottocrat_Index_View {
    ...
    public function process(Ottocrat_Request $request) {
        ...
        if(count($pickListFields) > 0) {
            ...
            $selectedFieldAllPickListValues = Ottocrat_Util_Helper::getPickListValues($selectedPickListFieldModel->getName());
