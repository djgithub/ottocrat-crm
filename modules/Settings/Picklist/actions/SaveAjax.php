...
class Settings_Picklist_SaveAjax_Action extends Settings_Ottocrat_Basic_Action {
    ...
    public function updateDefaultPicklistValues($pickListFieldName,$oldValue,$newValue) {
        $db = PearDatabase::getInstance();            
            ...
            $queryToGetId = 'SELECT id FROM ottocrat_users WHERE '.$defaultFieldName.' IN (';
            ...
            for($i=0; $i<$rowCount; $i++) {
                ...
                $record = Ottocrat_Record_Model::getInstanceById($recordId, 'Users');
    ...
    public function rename(Ottocrat_Request $request) {
        $moduleName = $request->get('source_module');
    ...
    public function remove(Ottocrat_Request $request) {
        $moduleName = $request->get('source_module');
     ...
     */
    public function assignValueToRole(Ottocrat_Request $request) {
        $pickListFieldName = $request->get('picklistName');
    ...
    public function saveOrder(Ottocrat_Request $request) {
        $pickListFieldName = $request->get('picklistName');
    ...
    public function enableOrDisable(Ottocrat_Request $request) {
        $pickListFieldName = $request->get('picklistName');
