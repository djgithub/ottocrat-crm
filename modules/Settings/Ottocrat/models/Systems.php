...
class Settings_Ottocrat_Systems_Model extends Ottocrat_Base_Model{

    const tableName = 'ottocrat_systems';
    ...
    public static function getInstanceFromServerType($type,$componentName) {
        ...
        try{
        $modelClassName = Ottocrat_Loader::getComponentClassName('Model', $componentName, 'Settings:Ottocrat');
        }catch(Exception $e) {
            $modelClassName = self;
        }
