...
class Settings_Ottocrat_TaxRecord_Model extends Ottocrat_Base_Model{
	...
	public function getCreateTaxUrl() {
		return '?module=Ottocrat&parent=Settings&view=TaxAjax';
	}
	
	public function getEditTaxUrl() {
		return '?module=Ottocrat&parent=Settings&view=TaxAjax&type='.$this->getType().'&taxid='.$this->getId();
	}
    ...
    public function addTax() {
        ...
        if($this->isShippingTax()) {
            $taxname = "shtax".$taxid;
            $query = "ALTER TABLE ottocrat_inventoryshippingrel ADD COLUMN $taxname decimal(7,3) DEFAULT NULL";
        } else {
            $taxname = "tax".$taxid;
            $query = "ALTER TABLE ottocrat_inventoryproductrel ADD COLUMN $taxname decimal(7,3) DEFAULT NULL";
        }
