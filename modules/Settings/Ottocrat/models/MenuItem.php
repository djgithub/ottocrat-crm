...
/*
 * Ottocrat Settings MenuItem Model Class
 */
class Settings_Ottocrat_MenuItem_Model extends Ottocrat_Base_Model {

	protected static $itemsTable = 'ottocrat_settings_field';
	...
	public static $transformedUrlMapping = array(
		...
		'index.php?module=Settings&action=listnotificationschedulers&parenttab=Settings' => 'index.php?module=Settings&submodule=Ottocrat&view=Schedulers',
		...
		'index.php?module=Settings&action=OrganizationConfig&parenttab=Settings' => 'index.php?parent=Settings&module=Ottocrat&view=CompanyDetails',
		'index.php?module=Settings&action=EmailConfig&parenttab=Settings' => 'index.php?parent=Settings&module=Ottocrat&view=OutgoingServerDetail',
		'index.php?module=Settings&action=CurrencyListView&parenttab=Settings' => 'index.php?parent=Settings&module=Currency&view=List',
		'index.php?module=Settings&action=TaxConfig&parenttab=Settings' => 'index.php?module=Ottocrat&parent=Settings&view=TaxIndex',
		...
		'index.php?module=Settings&action=OrganizationTermsandConditions&parenttab=Settings' => 'index.php?parent=Settings&module=Ottocrat&view=TermsAndConditionsEdit',
		'index.php?module=Settings&action=CustomModEntityNo&parenttab=Settings' => 'index.php?module=Ottocrat&parent=Settings&view=CustomRecordNumbering',
		'index.php?module=Settings&action=MailScanner&parenttab=Settings' => 'index.php?parent=Settings&module=MailConverter&view=List',
		'index.php?module=com_ottocrat_workflow&action=workflowlist&parenttab=Settings' => 'index.php?module=Workflows&parent=Settings&view=List',
		'index.php?module=com_ottocrat_workflow&action=workflowlist' => 'index.php?module=Workflows&parent=Settings&view=List',
		'index.php?module=ConfigEditor&action=index' => 'index.php?module=Ottocrat&parent=Settings&view=ConfigEditorDetail',
		...
		'index.php?module=Settings&action=Announcements&parenttab=Settings' => 'index.php?parent=Settings&module=Ottocrat&view=AnnouncementEdit',
	...
	public function setMenu($menuId) {
		$this->menu = Settings_Ottocrat_Menu_Model::getInstanceById($menuId);
		return $this;
	}

	/**
	 * Function to set the Menu to which the Item belongs, given Menu Model instance
	 * @param <Settings_Ottocrat_Menu_Model> $menu - Settings Menu Model instance
	 * @return Settings_Ottocrat_MenuItem_Model
	 */
	...
	public function getPinUnpinActionUrl() {
		return Ottocrat_Request:: encryptLink('index.php?module=Ottocrat&parent=Settings&action=Basic&mode=updateFieldPinnedStatus&fieldid='.$this->getId());
	}
	 ...
	 * @return Settings_Ottocrat_MenuItem_Model instance
	 */
	 ...
	 * @param <String> $name
	 * @param <Settings_Ottocrat_Menu_Model> $menuModel
	 * @return Settings_Ottocrat_MenuItem_Model instance
	 */
	public static function getInstance($name, $menuModel=false) {
		...
		if($db->num_rows($result) > 0) {
			...
			$menuItem = Settings_Ottocrat_MenuItem_Model::getInstanceFromArray($rowData);
			if($menuModel) {
