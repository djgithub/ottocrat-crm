...
class Settings_Ottocrat_OutgoingServer_Model extends Settings_Ottocrat_Systems_Model {
    ...
    public function getBody() {
        ...
        return 'Dear '.$currentUser->get('user_name').', <br><br><b> This is a test mail sent to confirm if a mail is 
                ...
                <br><br>Thanks  and  Regards,<br> Team Ottocrat <br><br>';
    }
    
    public function loadDefaultValues() {
        $defaultOutgoingServerDetails = OttocratConfig::getOD('DEFAULT_OUTGOING_SERVER_DETAILS');
	...
	public function getMenuItem() {
		$menuItem = Settings_Ottocrat_MenuItem_Model::getInstance('LBL_MAIL_SERVER_SETTINGS');
		return $menuItem;
	}
    
	public function getEditViewUrl() {
		$menuItem = $this->getMenuItem();
		return '?module=Ottocrat&parent=Settings&view=OutgoingServerEdit&block='.$menuItem->get('blockid').'&fieldid='.$menuItem->get('fieldid');
	}
	
	public function getDetailViewUrl() {
		$menuItem = $this->getMenuItem();
		return '?module=Ottocrat&parent=Settings&view=OutgoingServerDetail&block='.$menuItem->get('blockid').'&fieldid='.$menuItem->get('fieldid');
	}
