...
class Campaigns_Relation_Model extends Ottocrat_Relation_Model {
	...
	public function getEmailEnabledModulesInfoForDetailView() {
		return array(
				'Leads' => array('fieldName' => 'leadid', 'tableName' => 'ottocrat_campaignleadrel'),
				'Accounts' => array('fieldName' => 'accountid', 'tableName' => 'ottocrat_campaignaccountrel'),
				'Contacts' => array('fieldName' => 'contactid', 'tableName' => 'ottocrat_campaigncontrel')
		);
	}
	...
	public function getCampaignRelationStatusValues() {
		...
		$result = $db->pquery("SELECT campaignrelstatusid, campaignrelstatus FROM ottocrat_campaignrelstatus", array());
