...
class Contacts_ListView_Model extends Ottocrat_ListView_Model {
	...
	public function getListViewMassActions($linkParams) {
		...
		if($currentUserModel->hasModulePermission($emailModuleModel->getId())) {
			...
			//	'linkurl' => 'javascript:Ottocrat_List_Js.triggerSendEmail("index.php?module='.$this->getModule()->getName().'&view=MassActionAjax&mode=showComposeEmailForm&step=step1","Emails");',
		...
		if($SMSNotifierModuleModel && $currentUserModel->hasModulePermission($SMSNotifierModuleModel->getId())) {
			$massActionLink = array(
				...
				//'linkurl' => 'javascript:Ottocrat_List_Js.triggerSendSms("index.php?module='.$this->getModule()->getName().'&view=MassActionAjax&mode=showSendSMSForm","SMSNotifier");',
		...
		if($currentUserModel->hasModuleActionPermission($moduleModel->getId(), 'EditView')) {
			$massActionLink = array(
				...
				//'linkurl' => 'javascript:Ottocrat_List_Js.triggerTransferOwnership("index.php?module='.$moduleModel->getName().'&view=MassActionAjax&mode=transferOwnership")',
