...
// Fix For: http://trac.ottocrat.com/cgi-bin/trac.cgi/ticket/2107
...
$sql = "select filename,data,filesize from ottocrat_wordtemplatestorage where filename=?";
...
<OBJECT Name="ottocratVM" codebase="http://<?php echo $_SERVER["HTTP_HOST"] ?>/modules/Settings/ottocratVM.CAB#Version1,0,0,1"
