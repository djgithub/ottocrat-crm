...
GLOBAL $WP_USER,$WP_DB,$WP_PASSWORD,$OT_USER,$OT_DB,$OT_PASSWORD;
$WP_USER='logicint_tlruser';
$WP_DB='logicint_tlrsite';
$WP_PASSWORD='R9T$tR8v0dMZ';
$OT_USER='root';
$OT_DB='ottocrat6_3';
$OT_PASSWORD='';
...
ini_set('session.save_path',$_SERVER['DOCUMENT_ROOT'].'/projects/ottocratcrm6.3/SESS');
...
// url for customer portal (Example: http://ottocrat.com/portal)
$PORTAL_URL = 'http://localhost/projects/ottocratcrm6.3/customerportal';

// helpdesk support email id and support name (Example: 'support@ottocrat.com' and 'ottocrat support')
$HELPDESK_SUPPORT_EMAIL_ID = 'sales@logicintell.com';
$HELPDESK_SUPPORT_NAME = 'Ottocrat';
...
if(isset($_SESSION['username'])){
      ...
      $dbconfig['db_username'] =	$OT_USER;
      $dbconfig['db_name'] = $OT_DB;
      $dbconfig['db_password'] = $OT_PASSWORD;
}
...
$site_URL = 'http://localhost/projects/ottocratcrm6.3/';
// root directory path
$root_directory = 'C:/wamp/www/projects/ottocratcrm6.3/';
// cache direcory path
$cache_dir = 'cache/';
...
//Disable Stat Tracking of ottocrat CRM instance
$disable_stats_tracking = false;

// Generating Unique Application Key
$application_unique_key = '1a89c53d3ca6aa01325181b198d155da';
